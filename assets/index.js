(function () {
  ...
  function x(v) {
    const N = {};
    return (
      v.integrity && (N.integrity = v.integrity),
      v.referrerPolicy && (N.referrerPolicy = v.referrerPolicy),
...
function Jx() {
  ...
  function x(d, v, N) {
    ...
    return (
      (v = N.ref),
      { $$typeof: r, type: d, key: O, ref: v !== void 0 ? v : null, props: N }
    );
  }
  return ((wn.Fragment = y), (wn.jsx = x), (wn.jsxs = x), wn);
}
var Qf;
function Fx() {
  return (Qf || ((Qf = 1), (Sc.exports = Jx())), Sc.exports);
}
var n = Fx(),
  _c = { exports: {} },
  ne = {};
...
function $x() {
  ...
  ((Y.prototype.isReactComponent = {}),
    (Y.prototype.setState = function (f, E) {
        ...
        case "object":
          switch (f.$$typeof) {
            ...
            case y:
              ...
              break;
            case U:
              return ((k = f._init), z(k(f._payload), E, L, V, ae));
          }
      }
    if (k)
      return (
        ...
        Q(ae)
          ? ((L = ""),
            k != null && (L = k.replace(Bt, "$&/") + "/"),
            z(ae, E, L, "", function (Ra) {
              return Ra;
            }))
          : ae != null &&
          (Te(ae) &&
        ...
        E.then(
          function (L) {
            (f._status === 0 || f._status === -1) &&
              ((f._status = 1), (f._result = L));
          },
          function (L) {
            (f._status === 0 || f._status === -1) &&
              ((f._status = 2), (f._result = L));
          },
        ),
  ...
  return (
    ...
    (ne.cloneElement = function (f, E, L) {
      if (f == null)
        throw Error(
      ...
      var V = J({}, f.props),
        ae = f.key;
      if (E != null)
        for (ue in (E.key !== void 0 && (ae = "" + E.key), E))
          !ce.call(E, ue) ||
            ue === "key" ||
            ue === "__self" ||
            ue === "__source" ||
      ...
      if (ue === 1) V.children = L;
      else if (1 < ue) {
        for (var k = Array(ue), Ye = 0; Ye < ue; Ye++)
          k[Ye] = arguments[Ye + 2];
        V.children = k;
      }
      return ge(f.type, ae, V);
    }),
    (ne.createContext = function (f) {
      return (
        ...
        (f.Provider = f),
        (f.Consumer = { $$typeof: N, _context: f }),
        f
      );
    }),
    (ne.createElement = function (f, E, L) {
      var V,
        ae = {},
        ue = null;
      if (E != null)
        for (V in (E.key !== void 0 && (ue = "" + E.key), E))
          ce.call(E, V) &&
            V !== "key" &&
            V !== "__self" &&
            V !== "__source" &&
      ...
      if (k === 1) ae.children = L;
      else if (1 < k) {
        for (var Ye = Array(k), ze = 0; ze < k; ze++)
          Ye[ze] = arguments[ze + 2];
        ae.children = Ye;
      }
      if (f && f.defaultProps)
        for (V in ((k = f.defaultProps), k)) ae[V] === void 0 && (ae[V] = k[V]);
      return ge(f, ue, ae);
    }),
    ...
    (ne.isValidElement = Te),
    (ne.lazy = function (f) {
      return { $$typeof: U, _payload: { _status: -1, _result: f }, _init: P };
    }),
    (ne.memo = function (f, E) {
    ...
    (ne.startTransition = function (f) {
      ...
      try {
        ...
        (E !== null && L.types !== null && (E.types = L.types), (R.T = E));
      }
    }),
    ...
    (ne.useActionState = function (f, E, L) {
      return R.H.useActionState(f, E, L);
    }),
    (ne.useCallback = function (f, E) {
      return R.H.useCallback(f, E);
    }),
    ...
    (ne.useEffect = function (f, E) {
      return R.H.useEffect(f, E);
    }),
    (ne.useEffectEvent = function (f) {
      return R.H.useEffectEvent(f);
    }),
    (ne.useId = function () {
      return R.H.useId();
    }),
    (ne.useImperativeHandle = function (f, E, L) {
      return R.H.useImperativeHandle(f, E, L);
    }),
    (ne.useInsertionEffect = function (f, E) {
      return R.H.useInsertionEffect(f, E);
    }),
    (ne.useLayoutEffect = function (f, E) {
      return R.H.useLayoutEffect(f, E);
    }),
    (ne.useMemo = function (f, E) {
      return R.H.useMemo(f, E);
    }),
    (ne.useOptimistic = function (f, E) {
      return R.H.useOptimistic(f, E);
    }),
    (ne.useReducer = function (f, E, L) {
      return R.H.useReducer(f, E, L);
    }),
    ...
    (ne.useSyncExternalStore = function (f, E, L) {
      return R.H.useSyncExternalStore(f, E, L);
    }),
...
var Zf;
function Oc() {
  return (Zf || ((Zf = 1), (_c.exports = $x())), _c.exports);
}
var M = Oc();
const u0 = i0(M);
var zc = { exports: {} },
  ...
  return (
    ...
    ((Kf = 1),
      (function (r) {
        ...
        function Q(z) {
          if (((J = !1), q(z), !ee))
            if (x(C) !== null) ((ee = !0), Z || ((Z = !0), Re()));
            else {
              var B = x(b);
              B !== null && Ie(Q, B.startTime - z);
            }
        }
        var Z = !1,
          R = -1,
          ...
          ge = -1;
        function Ee() {
          return I ? !0 : !(r.unstable_now() - ge < ce);
        }
        function Te() {
          if (((I = !1), Z)) {
            ...
            try {
              e: {
                ((ee = !1), J && ((J = !1), W(R), (R = -1)), (le = !0));
                var P = G;
                try {
                  t: {
                    for (
                      q(z), T = x(C);
                      T !== null && !(T.expirationTime > z && Ee());
                    ) {
                      var be = T.callback;
                      if (typeof be == "function") {
                        ((T.callback = null), (G = T.priorityLevel));
                        var pe = be(T.expirationTime <= z);
                        if (((z = r.unstable_now()), typeof pe == "function")) {
                          ((T.callback = pe), q(z), (B = !0));
                          break t;
                        }
                        (T === x(C) && d(C), q(z));
                      } else d(C);
        ...
        ((r.unstable_IdlePriority = 5),
          ...
          (r.unstable_runWithPriority = function (z, B) {
            switch (z) {
              case 1:
              case 2:
              case 3:
...
var Jf;
function Ix() {
  return (Jf || ((Jf = 1), (Cc.exports = Wx())), Cc.exports);
}
var Mc = { exports: {} },
  $e = {};
var Ff;
function Px() {
  ...
  var r = Oc();
  function y(C) {
    var b = "https://react.dev/errors/" + C;
  ...
  return (
    ($e.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = d),
    ($e.createPortal = function (C, b) {
      var U =
    ...
    ($e.flushSync = function (C) {
      var b = O.T,
        U = d.p;
      try {
        if (((O.T = null), (d.p = 2), C)) return C();
      } finally {
        ((O.T = b), (d.p = U), d.d.f());
      }
    }),
    ($e.preconnect = function (C, b) {
      typeof C == "string" &&
        (b
          ? ((b = b.crossOrigin),
            (b =
    ...
    ($e.preinit = function (C, b) {
      if (typeof C == "string" && b && typeof b.as == "string") {
        var U = b.as,
          T = D(U, b.crossOrigin),
    ...
    ($e.requestFormReset = function (C) {
      d.d.r(C);
    }),
    ($e.unstable_batchedUpdates = function (C, b) {
      return C(b);
    }),
    ($e.useFormState = function (C, b, U) {
      return O.H.useFormState(C, b, U);
    }),
...
function eh() {
  ...
  return (r(), (Mc.exports = Px()), Mc.exports);
}
var Wf;
function th() {
  if (Wf) return Tn;
  ...
  var Ie = Array.isArray,
    z = y.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
  ...
  function E(e) {
    0 > pe || ((e.current = be[pe]), (be[pe] = null), pe--);
  }
  function L(e, t) {
    (pe++, (be[pe] = e.current), (e.current = t));
  }
  var V = f(null),
    ae = f(null),
    ue = f(null),
    k = f(null);
  function Ye(e, t) {
    switch ((L(ue, t), L(ae, e), L(V, null), t.nodeType)) {
      case 9:
      case 11:
  ...
  function Ra(e) {
    e.memoizedState !== null && L(k, e);
    var t = V.current,
      l = mf(t, e.type);
    t !== l && (L(ae, e), L(V, l));
  }
  function Bn(e) {
    (ae.current === e && (E(V), E(ae)),
      k.current === e && (E(k), (Cn._currentValue = P)));
  }
  var si, Lc;
  function Ml(e) {
    if (si === void 0)
...
` +
  ...
  var ci = Object.prototype.hasOwnProperty,
    ...
    dt = r.unstable_now,
    M0 = r.unstable_getCurrentPriorityLevel,
    Gc = r.unstable_ImmediatePriority,
    Xc = r.unstable_UserBlockingPriority,
    qn = r.unstable_NormalPriority,
    E0 = r.unstable_LowPriority,
    Qc = r.unstable_IdlePriority,
    w0 = r.log,
    T0 = r.unstable_setDisableYieldValue,
    ka = null,
    ot = null;
  function al(e) {
    if (
  ...
  var rt = Math.clz32 ? Math.clz32 : U0,
    ...
    O0 = Math.LN2;
  function U0(e) {
    return ((e >>>= 0), e === 0 ? 32 : (31 - ((D0(e) / O0) | 0)) | 0);
  }
  var Ln = 256,
    Yn = 262144,
    Gn = 4194304;
  ...
  var nl = Math.random().toString(36).slice(2),
    ...
    xi = "__reactEvents$" + nl,
    k0 = "__reactListeners$" + nl,
    B0 = "__reactHandles$" + nl,
    Wc = "__reactResources$" + nl,
    La = "__reactMarker$" + nl;
  function hi(e) {
    (delete e[Ve], delete e[Pe], delete e[xi], delete e[k0], delete e[B0]);
  }
  function $l(e) {
    var t = e[Ve];
    if (t) return t;
  ...
  function ad(e) {
    ...
    var l = t.getValue(),
      a = "";
    return (
      e && (a = ld(e) ? (e.checked ? "true" : "false") : e.value),
      (e = a),
        ...
        !l.hasOwnProperty(a) ||
          ...
          (a.indexOf("--") === 0
            ...
            : a === "float"
              ...
              : (e[a] = ""));
      for (var s in t)
        ((a = t[s]), t.hasOwnProperty(s) && l[s] !== a && ud(e, s, a));
    } else for (var i in t) t.hasOwnProperty(i) && ud(e, i, t[i]);
  }
  function gi(e) {
        ...
        case "input":
          if (
            ...
            for (t = 0; t < l.length; t++)
              ((a = l[t]), a.form === e.form && ad(a));
          }
          break e;
        case "textarea":
          sd(e, l.value, l.defaultValue);
          break e;
        case "select":
  ...
  function rd() {
    ...
    var e,
      ...
      l = t.length,
      a,
      s = "value" in sl ? sl.value : sl.textContent,
      i = s.length;
    for (e = 0; e < l && t[e] === s[e]; e++);
    var u = l - e;
    for (a = 1; a <= u && t[l - a] === s[i - a]; a++);
    return (Jn = s.slice(e, 1 < a ? 1 - a : void 0));
  }
  function Fn(e) {
    var t = e.keyCode;
    return (
  ...
  function et(e) {
    function t(l, a, s, i, u) {
      ...
      for (var c in e)
        e.hasOwnProperty(c) && ((l = e[c]), (this[c] = l ? l(i) : i[c]));
      return (
  ...
  var Tl = {
    ...
    md = et(In),
    K0 = T({}, In, { dataTransfer: 0 }),
    J0 = et(K0),
    F0 = T({}, Qa, { relatedTarget: 0 }),
    Ai = et(F0),
    $0 = T({}, Tl, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    W0 = et($0),
    I0 = T({}, Tl, {
  ...
  var sm = T({}, Qa, {
    ...
    dm = et(cm),
    om = T({}, Tl, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    rm = et(om),
    fm = T({}, In, {
      deltaX: function (e) {
        return "deltaX" in e
  ...
  function pm(e, t) {
    switch (e) {
      case "compositionend":
        return yd(t);
      case "keypress":
        return t.which !== 32 ? null : ((pd = !0), vd);
      case "textInput":
        return ((e = t.data), e === vd && pd ? null : e);
      default:
        return null;
    }
  }
  function gm(e, t) {
    if (na)
      return e === "compositionend" || (!Ei && gd(e, t))
        ? ((e = rd()), (Jn = _i = sl = null), (na = !1), e)
        : null;
    switch (e) {
      case "paste":
        return null;
    ...
    if (Yt) {
      ...
      if (!Ti) {
        ...
        (zd.setAttribute("oninput", "return;"),
          (Ti = typeof zd.oninput == "function"));
      }
      wi = Ti;
    } else wi = !1;
    _d = wi && (!document.documentMode || 9 < document.documentMode);
  }
  function Cd() {
    Ka && (Ka.detachEvent("onpropertychange", Ad), (Ja = Ka = null));
  }
  function Ad(e) {
    if (e.propertyName === "value" && Pn(Ja)) {
      var t = [];
      (Nd(t, Ja, e, ji(e)), od(jm, t));
    }
  }
  function Nm(e, t, l) {
    e === "focusin"
      ? (Cd(), (Ka = t), (Ja = l), Ka.attachEvent("onpropertychange", Ad))
      : e === "focusout" && Cd();
  }
  function Sm(e) {
  ...
  var ft = typeof Object.is == "function" ? Object.is : Cm;
  function Fa(e, t) {
    if (ft(e, t)) return !0;
    if (
      typeof e != "object" ||
    ...
    for (a = 0; a < l.length; a++) {
      var s = l[a];
      if (!ci.call(t, s) || !ft(e[s], t[s])) return !1;
    }
    return !0;
  }
  function Md(e) {
  ...
  var Am = Yt && "documentMode" in document && 11 >= document.documentMode,
    sa = null,
    Oi = null,
    $a = null,
    Ui = !1;
  ...
  function Ol(e) {
    ...
    var t = ia[e],
      l;
    for (l in t) if (t.hasOwnProperty(l) && l in Od) return (Hi[e] = t[l]);
    return e;
  }
  var Ud = Ol("animationend"),
    Hd = Ol("animationiteration"),
    Rd = Ol("animationstart"),
    Mm = Ol("transitionrun"),
    Em = Ol("transitionstart"),
    wm = Ol("transitioncancel"),
    kd = Ol("transitionend"),
    Bd = new Map(),
    Ri =
  ...
  function Bi(e, t, l, a) {
    return (ls(e, t, l, a), as(e));
  }
  function Ul(e, t) {
    return (ls(e, null, null, t), as(e));
  }
  function qd(e, t, l) {
    e.lanes |= l;
    var a = e.alternate;
  ...
  function ns(e, t, l, a, s, i) {
    var u = 0;
    if (((a = e), typeof e == "function")) qi(e) && (u = 1);
      ...
      e: switch (e) {
        ...
        case Q:
          return ((e = mt(13, l, t, s)), (e.elementType = Q), (e.lanes = i), e);
        case Z:
          return ((e = mt(19, l, t, s)), (e.elementType = Z), (e.lanes = i), e);
        default:
          ...
          ((u = 29),
            (l = Error(d(130, e === null ? "null" : typeof e, ""))),
            (a = null));
      }
    return (
      (t = mt(u, l, t, s)),
  ...
  function _t(e, t) {
    if (typeof e == "object" && e !== null) {
      ...
      return l !== void 0
        ? l
        : ((t = { value: e, source: t, stack: Yc(t) }), Gd.set(e, t), t);
    }
    return { value: e, source: t, stack: Yc(t) };
  }
  var da = [],
    oa = 0,
    ss = null,
    ...
    Ht = "";
  function Xt(e, t) {
    ((da[oa++] = Wa), (da[oa++] = ss), (ss = e), (Wa = t));
  }
  function Xd(e, t, l) {
    ((zt[Ct++] = Ut), (zt[Ct++] = Ht), (zt[Ct++] = il), (il = e));
    var a = Ut;
    e = Ht;
    var s = 32 - rt(a) - 1;
    ((a &= ~(1 << s)), (l += 1));
    ...
    if (30 < i) {
      ...
      ((i = (a & ((1 << u) - 1)).toString(32)),
        (a >>= u),
        (s -= u),
        (Ut = (1 << (32 - rt(t) + s)) | (l << s) | a),
        (Ht = i + e));
    } else ((Ut = (1 << i) | (l << s) | a), (Ht = e));
  }
  function Gi(e) {
  ...
  function Vd(e) {
    ...
    switch (((t[Ve] = e), (t[Pe] = a), l)) {
      ...
      case "video":
      case "audio":
        for (l = 0; l < jn.length; l++) oe(jn[l], t);
        break;
      case "source":
        oe("error", t);
        break;
      ...
      case "select":
        ...
        break;
      case "textarea":
        (oe("invalid", t), id(t, a.value, a.defaultValue, a.children));
    }
    ((l = a.children),
  ...
  function ra(e) {
    ...
    if (
      ...
      t === 27
        ? ((t = Ae), Nl(e.type) ? ((e = mc), (mc = null), (Ae = e)) : (Ae = t))
        : (Ae = Ze ? Et(e.stateNode.nextSibling) : null);
    return !0;
  }
  function Rl() {
    ((Ae = Ze = null), (me = !1));
  ...
  var Zi = f(null),
    ...
    Qt = null;
  function dl(e, t, l) {
    (L(Zi, t._currentValue), (t._currentValue = l));
  }
  function Vt(e) {
  ...
  function Ji(e, t, l, a) {
    ...
    for (s !== null && (s.return = e); s !== null;) {
      ...
      if (i !== null) {
        ...
        if (((u = s.return), u === null)) throw Error(d(341));
        ((u.lanes |= l),
          (i = u.alternate),
          i !== null && (i.lanes |= l),
          Ki(u, l, e),
    ...
    for (var s = t, i = !1; s !== null;) {
      ...
      if (s.tag === 10) {
        ...
        if (((u = u.memoizedProps), u !== null)) {
          var c = s.type;
          ft(s.pendingProps.value, u.value) ||
            (e !== null ? e.push(c) : (e = [c]));
        }
      } else if (s === k.current) {
        if (((u = s.alternate), u === null)) throw Error(d(387));
  ...
  function Hm(e, t) {
    ...
    return ($i++, t.then(Jd, Jd), t);
  }
  function Jd() {
    if (--$i === 0 && en !== null) {
      xa !== null && (xa.status = "fulfilled");
      var e = en;
      ((en = null), (ma = 0), (xa = null));
  ...
  function eo(e) {
    if (e === ha || e === ds) throw Error(d(483));
  }
  var ba = null,
    tn = 0;
  function rs(e) {
    var t = tn;
    return ((tn += 1), ba === null && (ba = []), Id(ba, e, t));
  }
  function ln(e, t) {
  ...
  function to(e) {
    ...
    function i(h, m, p) {
      return (
        ...
        e
          ? ((p = h.alternate),
            p !== null
              ? ((p = p.index), p < m ? ((h.flags |= 67108866), m) : p)
              : ((h.flags |= 67108866), m))
          : ((h.flags |= 1048576), m)
      );
    }
    ...
    function c(h, m, p, A) {
      return m === null || m.tag !== 6
        ? ((m = Li(p, h.mode, A)), (m.return = h), m)
        : ((m = s(m, p)), (m.return = h), m);
    }
    function o(h, m, p, A) {
      var F = p.type;
      return F === J
    ...
    function g(h, m, p, A) {
      return m === null ||
        ...
        ? ((m = Yi(p, h.mode, A)), (m.return = h), m)
        : ((m = s(m, p.children || [])), (m.return = h), m);
    }
    function _(h, m, p, A, F) {
      return m === null || m.tag !== 7
        ? ((m = Hl(p, h.mode, A, F)), (m.return = h), m)
        : ((m = s(m, p)), (m.return = h), m);
    }
    function w(h, m, p) {
      if (
        ...
        return ((m = Li("" + m, h.mode, p)), (m.return = h), m);
      if (typeof m == "object" && m !== null) {
        switch (m.$$typeof) {
          case le:
            return (
              (p = ns(m.type, m.key, m.props, null, h.mode, p)),
              ln(p, m),
              (p.return = h),
              p
            );
          case ee:
            return ((m = Yi(m, h.mode, p)), (m.return = h), m);
          case ce:
            return ((m = Ll(m)), w(h, m, p));
        }
        if (Ie(m) || Re(m))
          return ((m = Hl(m, h.mode, p, null)), (m.return = h), m);
        if (typeof m.then == "function") return w(h, rs(m), p);
        if (m.$$typeof === H) return w(h, us(h, m), p);
        fs(h, m);
      }
      return null;
    }
    function j(h, m, p, A) {
      ...
      if (
        ...
        return F !== null ? null : c(h, m, "" + p, A);
      if (typeof p == "object" && p !== null) {
        switch (p.$$typeof) {
          case le:
            return p.key === F ? o(h, m, p, A) : null;
          case ee:
            return p.key === F ? g(h, m, p, A) : null;
          case ce:
            return ((p = Ll(p)), j(h, m, p, A));
        }
        if (Ie(p) || Re(p)) return F !== null ? null : _(h, m, p, A, null);
        if (typeof p.then == "function") return j(h, m, rs(p), A);
        if (p.$$typeof === H) return j(h, m, us(h, p), A);
        fs(h, p);
      }
      return null;
    }
    function S(h, m, p, A, F) {
      if (
        (typeof A == "string" && A !== "") ||
        typeof A == "number" ||
        typeof A == "bigint"
      )
        return ((h = h.get(p) || null), c(m, h, "" + A, F));
      if (typeof A == "object" && A !== null) {
        switch (A.$$typeof) {
          case le:
            return (
              (h = h.get(A.key === null ? p : A.key) || null),
              o(m, h, A, F)
            );
          case ee:
            return (
          ...
          case ce:
            return ((A = Ll(A)), S(h, m, p, A, F));
        }
        if (Ie(A) || Re(A))
          return ((h = h.get(p) || null), _(m, h, A, F, null));
        if (typeof A.then == "function") return S(h, m, p, rs(A), F);
        if (A.$$typeof === H) return S(h, m, p, us(m, A), F);
        fs(m, A);
      }
      return null;
    }
    function X(h, m, p, A) {
      for (
        var F = null, xe = null, K = m, ie = (m = 0), fe = null;
        K !== null && ie < p.length;
        ie++
      ) {
        K.index > ie ? ((fe = K), (K = null)) : (fe = K.sibling);
        var he = j(h, K, p[ie], A);
        if (he === null) {
          K === null && (K = fe);
          break;
        }
        (e && K && he.alternate === null && t(h, K),
          (m = i(he, m, ie)),
          xe === null ? (F = he) : (xe.sibling = he),
          (xe = he),
          (K = fe));
      }
      if (ie === p.length) return (l(h, K), me && Xt(h, ie), F);
      if (K === null) {
        for (; ie < p.length; ie++)
          ((K = w(h, p[ie], A)),
            K !== null &&
    ...
    function te(h, m, p, A) {
      ...
      for (
        var F = null, xe = null, K = m, ie = (m = 0), fe = null, he = p.next();
        K !== null && !he.done;
        ie++, he = p.next()
      ) {
        K.index > ie ? ((fe = K), (K = null)) : (fe = K.sibling);
        var Al = j(h, K, he.value, A);
        if (Al === null) {
          K === null && (K = fe);
          break;
        }
        (e && K && Al.alternate === null && t(h, K),
          (m = i(Al, m, ie)),
          xe === null ? (F = Al) : (xe.sibling = Al),
          (xe = Al),
          (K = fe));
      }
      if (he.done) return (l(h, K), me && Xt(h, ie), F);
      if (K === null) {
    ...
    function _e(h, m, p, A) {
        ...
        switch (p.$$typeof) {
          case le:
            e: {
              ...
              p.type === J
                ? ((A = Hl(p.props.children, h.mode, A, p.key)),
                  (A.return = h),
                  (h = A))
                : ((A = ns(p.type, p.key, p.props, null, h.mode, A)),
                  ln(A, p),
                  (A.return = h),
                  (h = A));
            }
          ...
          case ee:
            e: {
              ...
              ((A = Yi(p, h.mode, A)), (A.return = h), (h = A));
            }
            return u(h);
          case ce:
            return ((p = Ll(p)), _e(h, m, p, A));
        }
        if (Ie(p)) return X(h, m, p, A);
        if (Re(p)) {
          if (((F = Re(p)), typeof F != "function")) throw Error(d(150));
          return ((p = F.call(p)), te(h, m, p, A));
        }
        if (typeof p.then == "function") return _e(h, m, rs(p), A);
        if (p.$$typeof === H) return _e(h, m, us(h, p), A);
        fs(h, p);
      }
      return (typeof p == "string" && p !== "") ||
        ...
        ? ((p = "" + p),
          m !== null && m.tag === 6
            ? (l(h, m.sibling), (A = s(m, p)), (A.return = h), (h = A))
            : (l(h, m), (A = Li(p, h.mode, A)), (A.return = h), (h = A)),
          u(h))
        : l(h, m);
    }
    return function (h, m, p, A) {
      try {
        tn = 0;
        var F = _e(h, m, p, A);
        return ((ba = null), F);
      } catch (K) {
        if (K === ha || K === ds) throw K;
        var xe = mt(29, K, null, h.mode);
        return ((xe.lanes = A), (xe.return = h), xe);
      }
    };
  }
  var Gl = to(!0),
  ...
  function sn(e, t, l, a) {
    ...
    if (c !== null) {
      ...
      var o = c,
        g = o.next;
      ((o.next = null), u === null ? (i = g) : (u.next = g), (u = o));
      var _ = e.alternate;
      _ !== null &&
        ((_ = _.updateQueue),
          (c = _.lastBaseUpdate),
  ...
  function no(e, t) {
    var l = e.callbacks;
    if (l !== null)
      for (e.callbacks = null, e = 0; e < l.length; e++) ao(l[e], t);
  }
  var va = f(null),
    ms = f(0);
  function so(e, t) {
    ((e = el), L(ms, e), L(va, t), (el = e | t.baseLanes));
  }
  function au() {
    (L(ms, el), L(va, va.current));
  }
  function nu() {
    ((el = ms.current), E(va), E(ms));
  }
  var xt = f(null),
    Mt = null;
  function ml(e) {
  ...
  function xl() {
    (L(Ue, Ue.current), L(xt, xt.current));
  }
  function ht(e) {
    (E(xt), Mt === e && (Mt = null), E(Ue));
  }
  var Ue = f(0);
  function xs(e) {
    for (var t = e; t !== null;) {
  ...
  function uu(e, t, l, a, s, i) {
    return (
      ...
      (t.updateQueue = null),
      (t.lanes = 0),
      (z.H = e === null || e.memoizedState === null ? Qo : Nu),
      (Xl = !1),
      (i = l(a, s)),
      (Xl = !1),
      pa && (i = co(t, l, a, s)),
  ...
  function uo(e) {
    ...
    if (((Zt = 0), (Be = Ne = se = null), (hs = !1), (un = 0), (ga = null), t))
      throw Error(d(300));
    e === null ||
      qe ||
      ((e = e.dependencies), e !== null && is(e) && (qe = !0));
  }
  function co(e, t, l, a) {
    se = e;
    var s = 0;
    do {
      if ((pa && (ga = null), (un = 0), (pa = !1), 25 <= s))
        throw Error(d(301));
      if (((s += 1), (Be = Ne = null), e.updateQueue != null)) {
        var i = e.updateQueue;
        ((i.lastEffect = null),
          (i.events = null),
          (i.stores = null),
  ...
  function ou(e) {
    ...
    ((Zt = 0), (Be = Ne = se = null), (pa = !1), (un = bs = 0), (ga = null));
  }
  function We() {
    var e = {
      memoizedState: null,
        ...
        if (w !== g.lane ? (re & w) === w : (Zt & w) === w) {
          ...
          if (j === 0)
            ...
            ((w = {
              ...
              o === null ? ((c = o = w), (u = i)) : (o = o.next = w),
              (se.lanes |= j),
              (vl |= j));
          ((w = g.action),
            Xl && l(i, w),
            (i = g.hasEagerState ? g.eagerState : l(i, w)));
        } else
          ((j = {
            lane: w,
            revertLane: g.revertLane,
  ...
  function ro(e, t, l) {
    ((e.flags |= 16384),
      ...
      (t = se.updateQueue),
      t === null
        ? ((t = vs()), (se.updateQueue = t), (t.stores = [e]))
        : ((l = t.stores), l === null ? (t.stores = [e]) : l.push(e)));
  }
  function fo(e, t, l, a) {
    ((t.value = l), (t.getSnapshot = a), xo(t) && ho(e));
  }
  function mo(e, t, l) {
    return l(function () {
      xo(t) && ho(e);
  ...
  function bo(e, t, l, a) {
    return ((e.baseState = l), fu(e, Ne, typeof a == "function" ? a : Kt));
  }
  function qm(e, t, l, a, s) {
    if (Ns(e)) throw Error(d(485));
  ...
  function No(e, t) {
        ...
        e: {
          ...
          if (me) {
            if (Ae) {
              ...
              if (s) {
                ((Ae = Et(s.nextSibling)), (a = s.data === "F!"));
                break e;
              }
            }
            cl(a);
    ...
    return (
      ...
      (a.dispatch = l),
      (a = xu(!1)),
      (i = ju.bind(null, se, !1, a.queue)),
      (a = We()),
      (s = { state: t, dispatch: null, action: e, pending: null }),
      (a.queue = s),
      (l = qm.bind(null, se, s, i, l)),
      (s.dispatch = l),
      (a.memoizedState = e),
      [t, l, !1]
    );
  ...
  function js(e, t, l, a) {
    ...
    Ne !== null && a !== null && iu(a, Ne.memoizedState.deps)
      ? (s.memoizedState = ya(t, i, l, a))
      : ((se.flags |= e), (s.memoizedState = ya(1 | t, i, l, a)));
  }
  function Ao(e, t) {
    ys(8390656, 8, e, t);
  }
  ...
  function Ym(e) {
    ...
    if (t === null) ((t = vs()), (se.updateQueue = t), (t.events = [e]));
    else {
      var l = t.events;
  ...
  function Oo(e, t) {
    ...
    return t !== null && iu(t, a[1]) ? a[0] : ((l.memoizedState = [e, t]), e);
  }
  function Uo(e, t) {
    var l = He();
    t = t === void 0 ? null : t;
    var a = l.memoizedState;
    if (t !== null && iu(t, a[1])) return a[0];
    if (((a = e()), Xl)) {
      al(!0);
      try {
        e();
  ...
  function pu(e, t, l) {
    return l === void 0 || ((Zt & 1073741824) !== 0 && (re & 261930) === 0)
      ? (e.memoizedState = t)
      : ((e.memoizedState = l), (e = Hr()), (se.lanes |= e), (vl |= e), l);
  }
  function Ho(e, t, l, a) {
    return ft(l, t)
      ? l
      : va.current !== null
        ? ((e = pu(e, l, a)), ft(e, t) || (qe = !0), e)
        : (Zt & 42) === 0 || ((Zt & 1073741824) !== 0 && (re & 261930) === 0)
          ? ((qe = !0), (e.memoizedState = l))
          : ((e = Hr()), (se.lanes |= e), (vl |= e), t);
  }
  function Ro(e, t, l, a, s) {
    var i = B.p;
    B.p = i !== 0 && 8 > i ? i : 8;
    var u = z.T,
      c = {};
  ...
  function Qm(e, t, l) {
    ...
    ((l = {
      ...
      Ns(e)
        ? Go(t, l)
        : ((l = Bi(e, t, l, a)), l !== null && (st(l, e, a), Xo(l, t, a))));
  }
  function Yo(e, t, l) {
    var a = pt();
    dn(e, t, l, a);
  ...
  var Qo = {
    ...
    Nu = {
      ...
      useDeferredValue: function (e, t) {
        var l = He();
        return Ho(l, Ne.memoizedState, e, t);
      },
      useTransition: function () {
        var e = gs(Kt)[0],
          t = He().memoizedState;
  ...
  var Vo = {
    ...
    useDeferredValue: function (e, t) {
      var l = He();
      return Ne === null ? pu(l, e, t) : Ho(l, Ne.memoizedState, e, t);
    },
    useTransition: function () {
      var e = mu(Kt)[0],
        t = He().memoizedState;
  ...
  var _u = {
    ...
    enqueueForceUpdate: function (e, t) {
      ...
      ((a.tag = 2),
        t != null && (a.callback = t),
        (t = fl(e, a, l)),
        t !== null && (st(t, e, l), an(t, e, l)));
    },
  };
  function Zo(e, t, l, a, s, i, u) {
    return (
      (e = e.stateNode),
    ...
    if (
      ...
      if (
        ...
        switch (l.tag) {
          ...
          case 13:
            return (
              Mt === null ? Hs() : l.alternate === null && Oe === 0 && (Oe = 3),
              (l.flags &= -257),
              (l.flags |= 65536),
              (l.lanes = s),
              a === os
      ...
      return (
        ...
        t !== null
          ? ((t.flags & 65536) === 0 && (t.flags |= 256),
            (t.flags |= 65536),
            (t.lanes = s),
            a !== Qi && ((e = Error(d(422), { cause: a })), Ia(_t(e, l))))
          : (a !== Qi && ((t = Error(d(423), { cause: a })), Ia(_t(t, l))),
            (e = e.current.alternate),
            (e.flags |= 65536),
            (s &= -s),
            (e.lanes |= s),
            (a = _t(a, l)),
            (s = zu(e.stateNode, a, s)),
            tu(e, s),
            Oe !== 4 && (Oe = 2)),
        !1
      );
  ...
  var Cu = Error(d(461)),
    qe = !1;
  function Je(e, t, l, a) {
    t.child = e === null ? lo(t, null, l, a) : Gl(t, e.child, l, a);
  }
  function er(e, t, l, a, s) {
    l = l.render;
    var i = t.ref;
    if ("ref" in a) {
      var u = {};
    ...
    return (
      ...
      e !== null && !qe
        ? (du(e, t, s), Jt(e, t, s))
        : (me && c && Gi(t), (t.flags |= 1), Je(e, t, a, s), t.child)
    );
  }
  function tr(e, t, l, a, s) {
    if (e === null) {
      var i = l.type;
      return typeof i == "function" &&
        ...
        l.compare === null
        ? ((t.tag = 15), (t.type = i), lr(e, t, i, a, s))
        : ((e = ns(l.type, null, a, t, t.mode, s)),
          (e.ref = t.ref),
          (e.return = t),
          (t.child = e));
    }
    if (((i = e.child), !Uu(e, s))) {
      ...
      if (
        ((l = l.compare), (l = l !== null ? l : Fa), l(u, a) && e.ref === t.ref)
      )
        return Jt(e, t, s);
    }
    return (
  ...
  function lr(e, t, l, a, s) {
    if (e !== null) {
      var i = e.memoizedProps;
      if (Fa(i, a) && e.ref === t.ref)
        if (((qe = !1), (t.pendingProps = a = i), Uu(e, s)))
          (e.flags & 131072) !== 0 && (qe = !0);
        else return ((t.lanes = e.lanes), Jt(e, t, s));
    }
    return Au(e, t, l, a, s);
  }
  function ar(e, t, l, a) {
    ...
    if (
      ...
      if ((l & 536870912) !== 0)
        ((t.memoizedState = { baseLanes: 0, cachePool: null }),
          e !== null && cs(t, i !== null ? i.cachePool : null),
          i !== null ? so(t, i) : au(),
          io(t));
      else
        return (
          (a = t.lanes = 536870912),
          nr(e, t, i !== null ? i.baseLanes | l : l, l, a)
        );
    } else
      i !== null
        ? (cs(t, i.cachePool), so(t, i), xl(), (t.memoizedState = null))
        : (e !== null && cs(t, null), au(), xl());
    return (Je(e, t, s, l), t.child);
  }
  function rn(e, t) {
    return (
      (e !== null && e.tag === 22) ||
  ...
  function Zm(e, t, l) {
    ...
    if (i !== null) {
      var u = i.dehydrated;
      if ((su(t), s))
        if (t.flags & 256) ((t.flags &= -257), (t = sr(e, t, l)));
        else if (t.memoizedState !== null)
          ((t.child = e.child), (t.flags |= 128), (t = null));
        else throw Error(d(558));
      else if (
        (qe || fa(e, t, l, !1), (s = (l & e.childLanes) !== 0), qe || s)
      ) {
        if (
          ((a = Ce),
  ...
  function Au(e, t, l, a, s) {
    return (
      Bl(t),
      (l = uu(e, t, l, a, void 0, s)),
      (a = cu()),
      e !== null && !qe
        ? (du(e, t, s), Jt(e, t, s))
        : (me && a && Gi(t), (t.flags |= 1), Je(e, t, l, s), t.child)
    );
  }
  function ir(e, t, l, a, s, i) {
    return (
      Bl(t),
      (t.updateQueue = null),
      (l = co(t, a, l, s)),
      ...
      e !== null && !qe
        ? (du(e, t, i), Jt(e, t, i))
        : (me && a && Gi(t), (t.flags |= 1), Je(e, t, l, i), t.child)
    );
  }
  function ur(e, t, l, a, s) {
    if ((Bl(t), t.stateNode === null)) {
      var i = ca,
        u = l.contextType;
      (typeof u == "object" && u !== null && (i = Ke(u)),
        (i = new l(a, i)),
        (t.memoizedState =
        ...
        Pi(t),
        (u = l.contextType),
        (i.context = typeof u == "object" && u !== null ? Ke(u) : ca),
        (i.state = t.memoizedState),
      ...
      var g = i.context,
        _ = l.contextType;
      ((u = ca), typeof _ == "object" && _ !== null && (u = Ke(_)));
    ...
    return (
      ...
      i || a
        ? ((i = t.stateNode),
          ...
          (t.flags |= 1),
          e !== null && a
            ? ((t.child = Gl(t, e.child, null, s)),
              (t.child = Gl(t, null, l, s)))
            : Je(e, t, l, s),
  ...
  function cr(e, t, l, a) {
    return (Rl(), (t.flags |= 256), Je(e, t, l, a), t.child);
  }
  var Mu = {
    dehydrated: null,
    treeContext: null,
  ...
  function dr(e, t, l) {
    ...
    if (o !== null && ((c = o.dehydrated), c !== null)) {
      if (i)
        t.flags & 256
          ? (ml(t), (t.flags &= -257), (t = Du(e, t, l)))
          : t.memoizedState !== null
            ? (xl(), (t.child = e.child), (t.flags |= 128), (t = null))
            : (xl(),
              (c = a.fallback),
              (s = t.mode),
              (a = Cs({ mode: "visible", children: a.children }, s)),
              (c = Hl(c, s, l, null)),
              (c.flags |= 2),
              (a.return = t),
              (c.return = t),
        ...
        (qe || fa(e, t, l, !1), (u = (l & e.childLanes) !== 0), qe || u)
      ) {
        if (
          ((u = Ce),
    ...
    return s
      ? (xl(),
        ...
        (o = e.child),
        (g = o.sibling),
        (a = Gt(o, { mode: "hidden", children: a.children })),
        (a.subtreeFlags = o.subtreeFlags & 65011712),
        g !== null ? (c = Gt(g, c)) : ((c = Hl(c, s, l, null)), (c.flags |= 2)),
        (c.return = t),
        (a.return = t),
        (a.sibling = c),
        (t.child = a),
  ...
  function Km(e, t, l) {
    switch (t.tag) {
      ...
      case 10:
        ...
        break;
      case 31:
        if (t.memoizedState !== null) return ((t.flags |= 128), su(t), null);
        break;
      case 13:
      ...
      case 19:
        ...
        return null;
      case 22:
        return ((t.lanes = 0), ar(e, t, l, t.pendingProps));
      case 24:
        dl(t, ke, e.memoizedState.cache);
    }
    return Jt(e, t, l);
  ...
  function fr(e, t, l) {
    if (e !== null)
      if (e.memoizedProps !== t.pendingProps) qe = !0;
        ...
        if (!Uu(e, l) && (t.flags & 128) === 0) return ((qe = !1), Km(e, t, l));
        qe = (e.flags & 131072) !== 0;
      }
    else ((qe = !1), me && (t.flags & 1048576) !== 0 && Xd(t, Wa, t.index));
    switch (((t.lanes = 0), t.tag)) {
      case 16:
        e: {
          ...
          if (((e = Ll(t.elementType)), (t.type = e), typeof e == "function"))
            qi(e)
              ? ((a = Ql(e, a)), (t.tag = 1), (t = ur(null, t, e, a, l)))
              : ((t.tag = 0), (t = Au(null, t, e, a, l)));
          else {
            if (e != null) {
              var s = e.$$typeof;
              if (s === q) {
                ((t.tag = 11), (t = er(null, t, e, a, l)));
                break e;
              } else if (s === R) {
                ((t.tag = 14), (t = tr(null, t, e, a, l)));
                break e;
              }
            }
            throw ((t = ct(e) || e), Error(d(306, t, "")));
          }
        }
        return t;
      case 0:
        return Au(e, t, t.type, t.pendingProps, l);
      case 1:
        return ((a = t.type), (s = Ql(a, t.pendingProps)), ur(e, t, a, s, l));
      case 3:
        e: {
          ...
          ((s = i.element), eu(e, t), sn(t, a, null, l));
          ...
          if (
            ...
            if (
              ...
              ((s = _t(Error(d(424)), t)), Ia(s), (t = cr(e, t, a, l)));
              break e;
            } else
              for (
      ...
      case 27:
        return (
          ...
          ((a = t.stateNode = jf(t.type, t.pendingProps, ue.current)),
            ...
            (At = !0),
            (s = Ae),
            Nl(t.type) ? ((mc = s), (Ae = Et(a.firstChild))) : (Ae = s)),
      ...
      case 4:
        return (
          Ye(t, t.stateNode.containerInfo),
          (a = t.pendingProps),
          e === null ? (t.child = Gl(t, null, a, l)) : Je(e, t, a, l),
          t.child
        );
      case 11:
      ...
      case 31:
        return Zm(e, t, l);
      case 22:
        return ar(e, t, l, t.pendingProps);
      case 24:
        return (
          Bl(t),
          (a = Ke(ke)),
          e === null
            ? ((s = Wi()),
              ...
              Pi(t),
              dl(t, ke, s))
            : ((e.lanes & l) !== 0 && (eu(e, t), sn(t, null, null, l), nn()),
              (s = e.memoizedState),
              (i = t.memoizedState),
              s.parent !== a
                ? ((s = { parent: a, cache: a }),
  ...
  function Hu(e, t, l, a, s) {
    if (((t = (e.mode & 32) !== 0) && (t = !1), t)) {
      if (((e.flags |= 16777216), (s & 335544128) === s))
        if (e.stateNode.complete) e.flags |= 8192;
        else if (qr()) e.flags |= 8192;
        else throw ((Yl = os), Ii);
    ...
    switch ((Xi(t), t.tag)) {
      ...
      case 26:
        ...
        return (
          e === null
            ? (Ft(t),
              i !== null ? (Me(t), mr(t, i)) : (Me(t), Hu(t, s, null, a, l)))
            : i
              ? i !== e.memoizedState
                ? (Ft(t), Me(t), mr(t, i))
      ...
      case 27:
        if (
          ...
          ((e = V.current),
            ra(t) ? Vd(t) : ((e = jf(s, a, l)), (t.stateNode = e), Ft(t)));
        }
        return (Me(t), null);
      case 5:
        if ((Bn(t), (s = t.type), e !== null && t.stateNode != null))
          e.memoizedProps !== a && Ft(t);
        else {
          if (!a) {
            if (t.stateNode === null) throw Error(d(166));
        ...
        return (
          Me(t),
          Hu(t, t.type, e === null ? null : e.memoizedProps, t.pendingProps, l),
          null
        );
      case 6:
        if (e && t.stateNode != null) e.memoizedProps !== a && Ft(t);
          ...
          if (((e = ue.current), ra(t))) {
            ...
            ((e = Gs(e).createTextNode(a)), (e[Ve] = t), (t.stateNode = e));
        }
        return (Me(t), null);
      case 31:
      ...
      case 4:
        return (ze(), e === null && ac(t.stateNode.containerInfo), Me(t), null);
      case 10:
        return (Vt(t.type), Me(t), null);
      case 19:
        if ((E(Ue), (a = t.memoizedState), a === null)) return (Me(t), null);
        if (((s = (t.flags & 128) !== 0), (i = a.rendering), i === null))
          if (s) fn(a, !1);
            ...
            a.tail !== null &&
              dt() > Ds &&
              ((t.flags |= 128), (s = !0), fn(a, !1), (t.lanes = 4194304));
          }
        else {
          if (!s)
            if (((e = xs(i)), e !== null)) {
  ...
  var $t = !1,
    ...
    Qe = null;
  function $m(e, t) {
    if (((e = e.containerInfo), (ic = Fs), (e = Td(e)), Di(e))) {
    ...
    for (
      uc = { focusedElem: e, selectionRange: l }, Fs = !1, Qe = t;
      Qe !== null;
    )
      if (
  ...
  function jr(e, t, l) {
    ...
    switch (l.tag) {
      ...
      case 1:
        if ((It(e, l), a & 4))
          if (((e = l.stateNode), t === null))
            ...
            var s = Ql(l.type, t.memoizedProps);
            t = t.memoizedState;
            try {
      ...
      case 26:
      case 5:
        (It(e, l), t === null && a & 4 && vr(l), a & 512 && xn(l, l.return));
        break;
      case 12:
        It(e, l);
        break;
      ...
      case 22:
        if (((a = l.memoizedState !== null || $t), !a)) {
          ((t = (t !== null && t.memoizedState !== null) || Le), (s = $t));
          var i = Le;
          (($t = a),
            (Le = t) && !i ? Pt(e, l, (l.subtreeFlags & 8772) !== 0) : It(e, l),
            ($t = s),
            (Le = i));
        }
        break;
  ...
  function Sr(e, t, l) {
    ...
    switch (l.tag) {
      ...
      case 21:
        ...
        break;
      case 22:
        ((Le = (a = Le) || l.memoizedState !== null), Wt(e, t, l), (Le = a));
        break;
      default:
        Wt(e, t, l);
    }
  ...
  function Wm(e) {
    switch (e.tag) {
      ...
      case 19:
        var t = e.stateNode;
        return (t === null && (t = e.stateNode = new yr()), t);
      case 22:
        return (
          (e = e.stateNode),
          (t = e._retryCache),
          t === null && (t = e._retryCache = new yr()),
          t
        );
      default:
      ...
      for (var a = 0; a < l.length; a++) {
        ...
        e: for (; c !== null;) {
          switch (c.tag) {
            ...
            case 3:
            case 4:
              ((we = c.stateNode.containerInfo), (tt = !0));
              break e;
          }
          c = c.return;
        }
  ...
  function Cr(e, t) {
    ...
    switch (e.tag) {
      ...
      case 15:
        (lt(t, e),
          at(e),
          a & 4 && (hl(3, e, e.return), mn(3, e), hl(5, e, e.return)));
        break;
      case 1:
        (lt(t, e),
          at(e),
          ...
          if (((a = e.memoizedState), l === null))
            if (a === null)
              if (e.stateNode === null) {
                e: {
                  ...
                  t: switch (a) {
                    case "title":
                      ...
                      break e;
                    case "link":
                      var u = Af("link", "href", s).get(a + (l.href || ""));
                      if (u) {
                ...
                e.stateNode = a;
              } else Mf(s, e.type, e.stateNode);
            else e.stateNode = Cf(s, a, e.memoizedProps);
          else
            i !== a
              ? (i === null
                ? l.stateNode !== null &&
      ...
      case 27:
        (lt(t, e),
          at(e),
          a & 512 && (Le || l === null || Rt(l, l.return)),
          l !== null && a & 4 && Ru(e, e.memoizedProps, l.memoizedProps));
        break;
      case 5:
        if (
          (lt(t, e),
        ...
        (a & 4 &&
          e.stateNode != null &&
          ((s = e.memoizedProps), Ru(e, s, l !== null ? l.memoizedProps : s)),
          a & 1024 && (qu = !0));
        break;
      case 6:
        if ((lt(t, e), at(e), a & 4)) {
      ...
      case 4:
        ((a = Dt),
          (Dt = Xs(e.stateNode.containerInfo)),
          lt(t, e),
          at(e),
          (Dt = a));
        break;
  ...
  function Vl(e) {
    for (e = e.child; e !== null;) {
      ...
      switch (t.tag) {
        ...
        case 14:
        case 15:
          (hl(4, t, t.return), Vl(t));
          break;
        case 1:
          Rt(t, t.return);
          var l = t.stateNode;
          (typeof l.componentWillUnmount == "function" && br(t, t.return, l),
            Vl(t));
          break;
        case 27:
          Sn(t.stateNode);
    ...
    for (l = l && (t.subtreeFlags & 8772) !== 0, t = t.child; t !== null;) {
      ...
      switch (i.tag) {
        ...
        case 1:
          ...
          (l && u & 64 && hr(i), xn(i, i.return));
          break;
        case 27:
          gr(i);
        case 26:
        case 5:
          (Pt(s, i, l), l && a === null && u & 4 && vr(i), xn(i, i.return));
          break;
        case 12:
          Pt(s, i, l);
          break;
        case 31:
          (Pt(s, i, l), l && u & 4 && _r(s, i));
          break;
        case 13:
          (Pt(s, i, l), l && u & 4 && zr(s, i));
          break;
        case 22:
          (i.memoizedState === null && Pt(s, i, l), xn(i, i.return));
          break;
        case 30:
          break;
        default:
  ...
  function Mr(e, t, l, a) {
    ...
    switch (t.tag) {
      ...
      case 22:
        ...
        break;
      case 24:
        (Ot(e, t, l, a), s & 2048 && Yu(t.alternate, t));
        break;
      default:
        Ot(e, t, l, a);
    }
  }
  function ja(e, t, l, a, s) {
    for (
        ...
        case 22:
          ...
          (u.memoizedState !== null
            ? _._visibility & 2
              ? ja(i, u, c, o, s)
              : hn(i, u)
            : ((_._visibility |= 2), ja(i, u, c, o, s)),
            s && g & 2048 && Lu(u.alternate, u));
          break;
        case 24:
          (ja(i, u, c, o, s), s && g & 2048 && Yu(u.alternate, u));
          break;
        default:
          ja(i, u, c, o, s);
      }
      ...
      for (t = t.child; t !== null;) {
        ...
        switch (a.tag) {
          case 22:
            ...
            break;
          case 24:
            (hn(l, a), s & 2048 && Yu(a.alternate, a));
            break;
          default:
            hn(l, a);
        }
  ...
  function Er(e, t, l) {
    switch (e.tag) {
      ...
      case 4:
        var a = Dt;
        ((Dt = Xs(e.stateNode.containerInfo)), Na(e, t, l), (Dt = a));
        break;
      case 22:
        e.memoizedState === null &&
          ((a = e.alternate),
  ...
  function Tr(e) {
    switch (e.tag) {
      ...
      case 11:
      case 15:
        (vn(e), e.flags & 2048 && hl(9, e, e.return));
        break;
      case 3:
        vn(e);
        break;
  ...
  function ws(e) {
    ...
    for (e = e.child; e !== null;) {
      switch (((t = e), t.tag)) {
        ...
        case 11:
        case 15:
          (hl(8, t, t.return), ws(t));
          break;
        case 22:
          ((l = t.stateNode),
            l._visibility & 2 && ((l._visibility &= -3), ws(t)));
          break;
        default:
          ws(t);
      }
  ...
  var Im = {
    ...
    Ku = null;
  function pt() {
    return (ve & 2) !== 0 && re !== 0 ? re & -re : z.T !== null ? Pu() : Fc();
  }
  function Hr() {
    if (vt === 0)
  ...
  function st(e, t, l) {
    (((e === Ce && (ye === 2 || ye === 9)) || e.cancelPendingCommit !== null) &&
      (Ca(e, 0), yl(e, re, vt, !1)),
      qa(e, l),
      ((ve & 2) === 0 || e !== Ce) &&
      (e === Ce &&
  ...
  function Rr(e, t, l) {
    ...
    var a = (!l && (t & 127) === 0 && (t & e.expiredLanes) === 0) || Ba(e, t),
      s = a ? lx(e, t) : Fu(e, t, !0),
      i = a;
    do {
      if (s === 0) {
        ...
        if (((l = e.current.alternate), i && !ex(l))) {
          ((s = Fu(e, t, !1)), (i = !1));
          continue;
        }
        if (s === 2) {
          ...
          if (u !== 0) {
            ...
            e: {
              ...
              if ((o && (Ca(c, u).flags |= 256), (u = Fu(c, u, !1)), u !== 2)) {
                if (Gu && !o) {
                  ((c.errorRecoveryDisabledLanes |= i), (Zl |= i), (s = 4));
                  break e;
                }
                ((i = nt),
                  (nt = s),
        ...
        e: {
          ...
          if ((t & 62914560) === t && ((s = Ts + 300 - dt()), 10 < s)) {
            if ((yl(a, t, vt, !bl), Xn(a, 0, !0) !== 0)) break e;
            ((tl = t),
              (a.timeoutHandle = xf(
                kr.bind(
                  null,
          ...
          kr(a, l, nt, Os, Qu, t, vt, Zl, _a, bl, i, null, -0, 0);
        }
      }
      break;
    } while (!0);
  ...
  function kr(e, t, l, a, s, i, u, c, o, g, _, w, j, S) {
    if (
      ...
      ((w = {
        ...
        Er(t, i, w));
      var X =
        (i & 62914560) === i ? Ts - dt() : (i & 4194048) === i ? Or - dt() : 0;
      if (((X = Bx(w, X)), X !== null)) {
        ((tl = i),
          (e.cancelPendingCommit = X(
            Vr.bind(null, e, t, i, l, a, s, u, c, o, _, w, null, j, S),
          )),
          yl(e, i, u, !g));
        return;
      }
  ...
  function Ca(e, t) {
    ...
    (l !== -1 && ((e.timeoutHandle = -1), yx(l)),
      (l = e.cancelPendingCommit),
      l !== null && ((e.cancelPendingCommit = null), l()),
      (tl = 0),
      Ju(),
      (Ce = e),
      (de = l = Gt(e.current, null)),
      (re = t),
      (ye = 0),
      (bt = null),
      (bl = !1),
        ...
        if (ye !== 0 && de !== null) {
          ...
          switch (ye) {
            ...
            case 6:
              xt.current === null && (t = !0);
              var g = ye;
              if (((ye = 0), (bt = null), Aa(e, c, o, g), l && Sa)) {
                u = 0;
                break e;
              }
              break;
            default:
              ((g = ye), (ye = 0), (bt = null), Aa(e, c, o, g));
          }
        }
        (tx(), (u = Oe));
        break;
          ...
          t: switch (ye) {
            ...
            case 5:
              ...
              switch (de.tag) {
                ...
                case 27:
                  var c = de;
                  if (u ? Ef(u) : c.stateNode.complete) {
                    ((ye = 0), (bt = null));
                    var o = c.sibling;
                    if (o !== null) de = o;
                    else {
                      var g = c.return;
                      g !== null ? ((de = g), Rs(g)) : (de = null);
                    }
                    break t;
                  }
              }
              ((ye = 0), (bt = null), Aa(e, t, i, 5));
              break;
            case 6:
              ((ye = 0), (bt = null), Aa(e, t, i, 6));
              break;
            case 8:
              (Ju(), (Oe = 6));
              break e;
  ...
  function Gr(e) {
    ...
    ((e.memoizedProps = e.pendingProps), t === null ? Rs(e) : (de = t));
  }
  function Xr(e) {
    var t = e,
      l = t.alternate;
    switch (t.tag) {
      case 15:
      case 0:
        t = ir(l, t, t.pendingProps, t.type, void 0, re);
        break;
      case 11:
        t = ir(l, t, t.pendingProps, t.type.render, t.ref, re);
        break;
      case 5:
        ou(t);
      default:
        (xr(l, t), (t = de = Ld(t, el)), (t = fr(l, t, el)));
    }
    ((e.memoizedProps = e.pendingProps), t === null ? Rs(e) : (de = t));
  }
  function Aa(e, t, l, a) {
    ((Qt = kl = null), ou(t), (ba = null), (tn = 0));
    var s = t.return;
    try {
      if (Vm(e, s, t, l, re)) {
        ((Oe = 1), Ss(e, _t(l, e.current)), (de = null));
        return;
      }
    } catch (i) {
      if (s !== null) throw ((de = s), i);
      ((Oe = 1), Ss(e, _t(l, e.current)), (de = null));
      return;
    }
    t.flags & 32768
      ...
      if ((t.subtreeFlags & 13878) !== 0 || l) {
        ...
        try {
          ...
          if (
            ...
            c &&
            c.ownerDocument &&
            wd(c.ownerDocument.documentElement, c)
          ) {
            if (o !== null && Di(c)) {
              var g = o.start,
                _ = o.end;
              if ((_ === void 0 && (_ = g), "selectionStart" in c))
                ((c.selectionStart = g),
                  (c.selectionEnd = Math.min(_, c.value.length)));
              else {
                var w = c.ownerDocument || document,
                  j = (w && w.defaultView) || window;
                if (j.getSelection) {
                  var S = j.getSelection(),
                    X = c.textContent.length,
                    te = Math.min(o.start, X),
                    _e = o.end === void 0 ? te : Math.min(o.end, X);
                  !S.extend && te > _e && ((u = _e), (_e = te), (te = u));
                  var h = Ed(c, te),
                    m = Ed(c, _e);
                  if (
                    h &&
                    ...
                    (S.rangeCount !== 1 ||
                      ...
                      S.focusNode !== m.node ||
                      S.focusOffset !== m.offset)
                  ) {
                    var p = w.createRange();
                    (p.setStart(h.node, h.offset),
                      S.removeAllRanges(),
                      te > _e
                        ? (S.addRange(p), S.extend(m.node, m.offset))
                        : (p.setEnd(m.node, m.offset), S.addRange(p)));
                  }
                }
              }
            }
  ...
  function Jr() {
    if (Ge === 4 || Ge === 3) {
      ...
      (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0
        ? (Ge = 5)
        : ((Ge = 0), (za = gl = null), Fr(e, e.pendingLanes));
  ...
  function $r() {
    ...
    var l = mi(tl),
      ...
      s = B.p;
    try {
      ((B.p = 32 > l ? 32 : l), (z.T = null), (l = Zu), (Zu = null));
      var i = gl,
        u = tl;
      if (((Ge = 0), (za = gl = null), (tl = 0), (ve & 6) !== 0))
        throw Error(d(331));
      var c = ve;
      if (
        ((ve |= 4),
  ...
  function $u(e, t, l) {
    ...
    s.has(l) ||
      ((Gu = !0), s.add(l), (e = nx.bind(null, e, t, l)), t.then(e, e));
  }
  function nx(e, t, l) {
    var a = e.pingCache;
    (a !== null && a.delete(t),
  ...
  function Ir(e, t) {
    (t === 0 && (t = Vc()), (e = Ul(e, t)), e !== null && (qa(e, t), kt(e)));
  }
  function sx(e) {
    var t = e.memoizedState,
      l = 0;
    (t !== null && (l = t.retryLane), Ir(e, l));
  }
  function ix(e, t) {
    var l = 0;
    switch (e.tag) {
  ...
  function Pr() {
    ...
    for (var t = dt(), l = null, a = Bs; a !== null;) {
      ...
      (i === 0
        ? ((a.next = null),
          l === null ? (Bs = s) : (l.next = s),
          s === null && (Ma = l))
        : ((l = a), (e !== 0 || (i & 3) !== 0) && (qs = !0)),
        (a = s));
    }
    ((Ge !== 0 && Ge !== 5) || yn(e), jl !== 0 && (jl = 0));
  }
  function ef(e, t) {
    for (
  ...
  function tf(e, t) {
    ...
    if (ks() && e.callbackNode !== l) return null;
    var a = re;
    return (
      (a = Xn(
        e,
  ...
  for (var ec = 0; ec < Ri.length; ec++) {
    var tc = Ri[ec],
      rx = tc.toLowerCase(),
      fx = tc[0].toUpperCase() + tc.slice(1);
    Tt(rx, "on" + fx);
  }
  (Tt(Ud, "onAnimationEnd"),
    Tt(Hd, "onAnimationIteration"),
    Tt(Rd, "onAnimationStart"),
    Tt("dblclick", "onDoubleClick"),
    Tt("focusin", "onFocus"),
    Tt("focusout", "onBlur"),
    Tt(Mm, "onTransitionRun"),
    Tt(Em, "onTransitionStart"),
    Tt(wm, "onTransitionCancel"),
        ...
        if (t)
          for (var u = a.length - 1; 0 <= u; u--) {
            var c = a[u],
              o = c.instance,
              g = c.currentTarget;
            if (((c = c.listener), o !== i && s.isPropagationStopped()))
              break e;
  ...
  function oe(e, t) {
    var l = t[xi];
    l === void 0 && (l = t[xi] = new Set());
    var a = e + "__bubble";
    l.has(a) || (uf(t, e, 2, !1), l.add(a));
  }
  function lc(e, t, l) {
    var a = 0;
    (t && (a |= 4), uf(l, e, a, t));
    ...
    if (!e[Ls]) {
      ((e[Ls] = !0),
        Ic.forEach(function (l) {
          l !== "selectionchange" && (mx.has(l) || lc(l, !1, e), lc(l, !0, e));
        }));
      var t = e.nodeType === 9 ? e : e.ownerDocument;
      t === null || t[Ls] || ((t[Ls] = !0), lc("selectionchange", !1, t));
    }
  }
  function uf(e, t, l, a) {
    switch (Rf(t)) {
      ...
      if ((t & 7) === 0) {
        e: {
          ...
          if (
            ...
            (S !== null && cf(w, j, S, te, !1),
              X !== null && _e !== null && cf(w, _e, X, te, !0));
          }
        }
        e: {
          if (
        ...
        (fe &&
          (bd &&
            l.locale !== "ko" &&
            (na || fe !== "onCompositionStart"
              ? fe === "onCompositionEnd" && na && (ie = rd())
              : ((sl = _),
...
`,
    ...
    switch (l) {
      ...
      case "formAction":
        if (typeof a == "function") {
          ...
          typeof i == "function" &&
            (l === "formAction"
              ? (t !== "input" && Se(e, t, "name", s.name, s, null),
                Se(e, t, "formEncType", s.formEncType, s, null),
                Se(e, t, "formMethod", s.formMethod, s, null),
                Se(e, t, "formTarget", s.formTarget, s, null))
              : (Se(e, t, "encType", s.encType, s, null),
                Se(e, t, "method", s.method, s, null),
                Se(e, t, "target", s.target, s, null)));
      ...
      default:
        (!(2 < l.length) ||
          (l[0] !== "o" && l[0] !== "O") ||
          (l[1] !== "n" && l[1] !== "N")) &&
          ((l = Q0.get(l) || l), Qn(e, l, a));
    }
  }
  function sc(e, t, l, a, s, i) {
    switch (l) {
      case "style":
        cd(e, a, i);
        break;
  ...
  function Fe(e, t, l) {
    switch (t) {
      ...
      case "img":
        ...
        (s && Se(e, t, "srcSet", l.srcSet, l, null),
      ...
      case "video":
      case "audio":
        for (a = 0; a < jn.length; a++) oe(jn[a], e);
        break;
      case "image":
        (oe("error", e), oe("load", e));
        break;
      ...
      default:
        if (gi(t)) {
          for (_ in l)
            l.hasOwnProperty(_) &&
              ((a = l[_]), a !== void 0 && sc(e, t, _, a, l, void 0));
          return;
        }
    }
    for (c in l)
      l.hasOwnProperty(c) && ((a = l[c]), a != null && Se(e, t, c, a, l, null));
  }
  function vx(e, t, l, a) {
    switch (t) {
      case "div":
          ...
          if (l.hasOwnProperty(S) && w != null)
            switch (S) {
              ...
              case "defaultValue":
                o = w;
              default:
                a.hasOwnProperty(S) || Se(e, t, S, null, a, w);
            }
        }
        for (var j in a) {
          var S = a[j];
          if (((w = l[j]), a.hasOwnProperty(j) && (S != null || w != null)))
            switch (j) {
              case "type":
                i = S;
                break;
          ...
          if (((o = l[i]), l.hasOwnProperty(i) && o != null))
            switch (i) {
              ...
              case "multiple":
                S = o;
              default:
                a.hasOwnProperty(i) || Se(e, t, i, null, a, o);
            }
        for (s in a)
          if (
            ((i = a[s]),
    ...
    if (typeof performance.getEntriesByType == "function") {
      for (
        ...
        var s = l[a],
          ...
          c = s.duration;
        if (i && c && rf(u)) {
          for (u = 0, c = s.responseEnd, a += 1; a < l.length; a++) {
            var o = l[a],
              g = o.startTime;
            if (g > c) break;
            ...
            _ &&
              rf(w) &&
              ((o = o.responseEnd), (u += _ * (o < c ? 1 : (c - g) / (o - g))));
          }
  ...
  function bf(e, t) {
    ...
    do {
      ...
      if ((e.removeChild(l), s && s.nodeType === 8))
        ...
        } else l === "body" && Sn(e.ownerDocument.body);
      l = s;
    } while (l);
    Da(t);
  }
  ...
  var ll = B.d;
  B.d = { f: Cx, r: Ax, D: Mx, C: Ex, L: wx, m: Tx, X: Ox, S: Dx, M: Ux };
  function Cx() {
    var e = ll.f(),
      t = Us();
    return e || t;
  ...
  function Ax(e) {
    var t = Wl(e);
    t !== null && t.tag === 5 && t.type === "form" ? Bo(t) : ll.r(e);
  }
  ...
  function Mx(e) {
    (ll.D(e), Sf("dns-prefetch", e, null));
  }
  function Ex(e, t) {
    (ll.C(e, t), Sf("preconnect", e, t));
  }
  function wx(e, t, l) {
    ll.L(e, t, l);
    var a = Ea;
  ...
  function Dx(e, t, l) {
    ...
    var a = Ea;
    if (a && e) {
      var s = Il(a).hoistableStyles,
        i = wa(e);
      t = t || "default";
      var u = s.get(i);
      if (!u) {
        var c = { loading: 0, preload: null };
        if ((u = a.querySelector(_n(i)))) c.loading = 5;
        else {
          ...
          (Xe(o),
            Fe(o, "link", e),
            (o._p = new Promise(function (g, _) {
              ((o.onload = g), (o.onerror = _));
            })),
    ...
    if ((t.count++, t.instance === null))
      switch (t.type) {
        ...
        case "script":
          return (
            (i = Ta(l.src)),
            (s = e.querySelector(zn(i)))
              ? ((t.instance = s), Xe(s), s)
              : ((a = l),
                (s = wt.get(i)) && ((a = T({}, l)), hc(a, s)),
                (e = e.ownerDocument || e),
      ...
      t.type === "stylesheet" &&
        (t.state.loading & 4) === 0 &&
        ((a = t.instance), (t.state.loading |= 4), Qs(a, l.precedence, e));
    return t.instance;
  }
  function Qs(e, t, l) {
    for (
  ...
  function Af(e, t, l) {
    if (Vs === null) {
      var a = new Map(),
        s = (Vs = new Map());
      s.set(l, a);
    } else ((s = Vs), (a = s.get(l)), a || ((a = new Map()), s.set(l, a)));
    if (a.has(e)) return a;
    for (
  ...
  function wf(e, t, l, a, s, i, u, c, o, g, _, w) {
    return (
      (e = new Lx(e, t, l, u, o, g, _, w, c)),
      (t = 1),
      i === !0 && (t |= 24),
      (i = mt(3, null, null, t)),
      (e.current = i),
              ...
              case 3:
                if (((i = i.stateNode), i.current.memoizedState.isDehydrated)) {
                  ...
                  if (u !== 0) {
                    ...
                    (kt(i), (ve & 6) === 0 && ((Ds = dt() + 500), yn(0)));
                  }
                }
                break;
              case 31:
              case 13:
                ((c = Ul(i, 2)), c !== null && st(c, i, 2), Us(), vc(i, 2));
            }
          if (((i = gc(a)), i === null && nc(e, t, a, $s, l), i === s)) break;
          s = i;
        }
  ...
  function Qx(e, t, l, a, s) {
    switch (t) {
      case "focusin":
        return ((Sl = En(Sl, e, t, l, a, s)), !0);
      case "dragenter":
        return ((_l = En(_l, e, t, l, a, s)), !0);
      case "mouseover":
        return ((zl = En(zl, e, t, l, a, s)), !0);
      case "pointerover":
        var i = s.pointerId;
        return (An.set(i, En(An.get(i) || null, e, t, l, a, s)), !0);
      case "gotpointercapture":
        return (
          (i = s.pointerId),
          Mn.set(i, En(Mn.get(i) || null, e, t, l, a, s)),
          !0
        );
    }
    return !1;
  ...
  function Ws(e) {
    ...
    for (var t = e.targetContainers; 0 < t.length;) {
      ...
      } else return ((t = Wl(l)), t !== null && Uf(t), (e.blockedOn = l), !1);
      t.shift();
    }
    return !0;
  }
  ...
  function Vx() {
    ((jc = !1),
      Sl !== null && Ws(Sl) && (Sl = null),
      _l !== null && Ws(_l) && (_l = null),
      zl !== null && Ws(zl) && (zl = null),
      An.forEach(qf),
      Mn.forEach(qf));
  }
  function Is(e, t) {
    ...
    if (((l = (e.ownerDocument || e).$$reactFormReplay), l != null))
      for (a = 0; a < l.length; a += 3) {
        var s = l[a],
          i = l[a + 1],
          u = s[Pe] || null;
        if (typeof i == "function") u || Lf(l);
        else if (u) {
          var c = null;
          if (i && i.hasAttribute("formAction")) {
            if (((s = i), (u = i[Pe] || null))) c = u.formAction;
  ...
  ((ei.prototype.render = Nc.prototype.render =
    function (e) {
      var t = this._internalRoot;
      if (t === null) throw Error(d(409));
      var l = t.current,
        a = pt();
      Df(l, a, e, t, null, null);
    }),
    (ei.prototype.unmount = Nc.prototype.unmount =
      function () {
        var e = this._internalRoot;
        if (e !== null) {
          this._internalRoot = null;
          var t = e.containerInfo;
          (Df(e.current, 2, null, e, null, null), Us(), (t[Fl] = null));
        }
      }));
  function ei(e) {
    this._internalRoot = e;
  ...
  ei.prototype.unstable_scheduleHydration = function (e) {
    if (e) {
      ...
      (Cl.splice(l, 0, e), l === 0 && Bf(e));
    }
  };
  var Gf = y.version;
  if (Gf !== "19.2.3") throw Error(d(527, Gf, "19.2.3"));
  ...
  return (
    (Tn.createRoot = function (e, t) {
      ...
      return (
        ...
        (t = wf(e, 1, !1, null, null, l, a, null, s, i, u, Yf)),
        (e[Fl] = t.current),
        ac(e),
        new Nc(t)
      );
    ...
    (Tn.hydrateRoot = function (e, t, l) {
      ...
      return (
        ...
        (t = wf(e, 1, !0, t, l ?? null, a, s, o, i, u, c, Yf)),
        (t.context = Tf(null)),
        (l = t.current),
        (a = pt()),
        (a = fi(a)),
...
function lh() {
  ...
  return (r(), (zc.exports = th()), zc.exports);
}
var ah = lh();
const nh = i0(ah),
  gt = {
    users: [
      {
        ...
        role: "AGENT",
        arn_code: "ARN-12345",
        email: "rajesh.k@moneyjunction.in",
    ...
    agent_client_map: [
      {
        ...
        client_id: "usr_002",
        status: "ACTIVE",
        linked_date: "2024-01-15",
      },
      {
        agent_id: "usr_001",
        client_id: "usr_003",
        status: "ACTIVE",
        linked_date: "2024-02-10",
      },
      {
        agent_id: "usr_001",
        client_id: "usr_004",
        status: "ACTIVE",
        linked_date: "2024-03-05",
      },
      {
        agent_id: "usr_001",
        client_id: "usr_005",
        status: "ACTIVE",
        linked_date: "2024-03-20",
      },
    ],
    holdings: [
      {
      ...
      },
      {
        ...
        pan: "KLMNO9012P",
        asset_class: "INSURANCE",
        scheme_name: "HDFC Life Click 2 Protect",
        sub_category: "Term Insurance",
      ...
      },
      {
        ...
        pan: "KLMNO9012P",
        asset_class: "INSURANCE",
        scheme_name: "Max Bupa Health Companion",
        sub_category: "Health Insurance",
        policy_number: "MB99887766",
        premium_amount: 12e3,
        sum_assured: 5e5,
      ...
      },
      {
        ...
        pan: "KLMNO9012P",
        asset_class: "INSURANCE",
        scheme_name: "Bajaj Allianz Car Protect",
        sub_category: "Vehicle Insurance",
        policy_number: "BA55443322",
        premium_amount: 8500,
        sum_assured: 6e5,
      ...
      },
      {
        ...
        pan: "PQRST3456U",
        asset_class: "INSURANCE",
        scheme_name: "Star Health Comprehensive",
        sub_category: "Health Insurance",
      ...
      },
      {
        ...
        pan: "PQRST3456U",
        asset_class: "INSURANCE",
        scheme_name: "ICICI Lombard Motor Protect",
        sub_category: "Vehicle Insurance",
        policy_number: "IL98765432",
        premium_amount: 5500,
        sum_assured: 8e5,
    ...
    notifications: [
      {
        id: 1,
        title: "SIP Due",
        message: "Anjali's SIP for HDFC Top 100 is due tomorrow.",
        type: "alert",
        date: "Today",
      },
      {
        id: 2,
        title: "New Client",
        message: "Rahul Deshmukh has been successfully linked.",
        type: "info",
        date: "Yesterday",
      },
      {
        ...
        message: "Sneha's HDFC Life policy renewal is coming up.",
        type: "warning",
        date: "2 days ago",
      },
      {
        id: 4,
        title: "Market Update",
        message: "Nifty 50 hit an all-time high today!",
        type: "info",
        date: "3 days ago",
      },
      {
        id: 5,
        title: "KYC Pending",
        message: "Vikram Singh's KYC update is pending approval.",
        type: "alert",
        date: "4 days ago",
      },
      {
        ...
        message: "Received dividend of ₹2,500 from ITC Ltd.",
        type: "success",
        date: "5 days ago",
      },
      {
        id: 7,
        title: "Goal Achieved",
        message: "Congratulations! You've reached 50% of your retirement goal.",
        type: "success",
        date: "1 week ago",
      },
      {
      ...
      },
      {
        ...
        message: "Tata Nifty 500 Index Fund NFO is now open.",
        type: "info",
        date: "2 weeks ago",
      },
      {
    ...
    performance_data: {
      usr_001: [
        { date: "2019-04-01", value: 120 },
        { date: "2019-07-01", value: 135 },
        { date: "2019-10-01", value: 142 },
        { date: "2020-01-01", value: 155 },
        { date: "2020-04-01", value: 140 },
        { date: "2020-07-01", value: 160 },
        { date: "2020-10-01", value: 175 },
        { date: "2021-01-01", value: 190 },
        { date: "2021-04-01", value: 210 },
        { date: "2021-07-01", value: 225 },
        { date: "2021-10-01", value: 240 },
        { date: "2022-01-01", value: 255 },
        { date: "2022-04-01", value: 270 },
        { date: "2022-07-01", value: 285 },
        { date: "2022-10-01", value: 300 },
        { date: "2023-01-01", value: 320 },
        { date: "2023-04-01", value: 340 },
        { date: "2023-07-01", value: 360 },
        { date: "2023-10-01", value: 380 },
        { date: "2024-01-01", value: 400 },
        { date: "2024-02-01", value: 410 },
        { date: "2024-03-01", value: 425 },
        { date: "2024-04-01", value: 435 },
      ],
      usr_002: [
        { date: "2019-04-01", value: 4.5 },
        { date: "2019-07-01", value: 4.8 },
        { date: "2019-10-01", value: 5 },
        { date: "2020-01-01", value: 5.2 },
        { date: "2020-04-01", value: 4.9 },
        { date: "2020-07-01", value: 5.4 },
        { date: "2020-10-01", value: 5.6 },
        { date: "2021-01-01", value: 5.8 },
        { date: "2021-04-01", value: 6 },
        { date: "2021-07-01", value: 6.2 },
        { date: "2021-10-01", value: 6.4 },
        { date: "2022-01-01", value: 6.6 },
        { date: "2022-04-01", value: 6.8 },
        { date: "2022-07-01", value: 7 },
        { date: "2022-10-01", value: 7.2 },
        { date: "2023-01-01", value: 7.5 },
        { date: "2023-04-01", value: 7.8 },
        { date: "2023-07-01", value: 8 },
        { date: "2023-10-01", value: 8.2 },
        { date: "2024-01-01", value: 8.5 },
        { date: "2024-02-01", value: 8.6 },
        { date: "2024-03-01", value: 8.7 },
        { date: "2024-04-01", value: 8.8 },
      ],
      usr_003: [
        { date: "2019-04-01", value: 10.5 },
        { date: "2019-07-01", value: 11 },
        { date: "2019-10-01", value: 11.5 },
        { date: "2020-01-01", value: 12 },
        { date: "2020-04-01", value: 11.2 },
        { date: "2020-07-01", value: 12.5 },
        { date: "2020-10-01", value: 13 },
        { date: "2021-01-01", value: 13.5 },
        { date: "2021-04-01", value: 14 },
        { date: "2021-07-01", value: 14.5 },
        { date: "2021-10-01", value: 15 },
        { date: "2022-01-01", value: 15.5 },
        { date: "2022-04-01", value: 16 },
        { date: "2022-07-01", value: 16.5 },
        { date: "2022-10-01", value: 17 },
        { date: "2023-01-01", value: 17.5 },
        { date: "2023-04-01", value: 18 },
        { date: "2023-07-01", value: 18.5 },
        { date: "2023-10-01", value: 19 },
        { date: "2024-01-01", value: 19.5 },
        { date: "2024-02-01", value: 19.8 },
        { date: "2024-03-01", value: 20 },
        { date: "2024-04-01", value: 20.5 },
      ],
      usr_004: [
        { date: "2019-04-01", value: 2.5 },
        { date: "2019-07-01", value: 2.6 },
        { date: "2019-10-01", value: 2.8 },
        { date: "2020-01-01", value: 3 },
        { date: "2020-04-01", value: 2.7 },
        { date: "2020-07-01", value: 3.2 },
        { date: "2020-10-01", value: 3.4 },
        ...
        { date: "2022-04-01", value: 4.7 },
        { date: "2022-07-01", value: 4.9 },
        { date: "2022-10-01", value: 5.1 },
        { date: "2023-01-01", value: 5.3 },
        { date: "2023-04-01", value: 5.5 },
        { date: "2023-07-01", value: 5.8 },
        { date: "2023-10-01", value: 6 },
        { date: "2024-01-01", value: 6.2 },
        { date: "2024-02-01", value: 6.3 },
        { date: "2024-03-01", value: 6.4 },
        { date: "2024-04-01", value: 6.5 },
      ],
      usr_005: [
        { date: "2019-04-01", value: 8 },
        { date: "2019-07-01", value: 8.5 },
        { date: "2019-10-01", value: 9 },
        { date: "2020-01-01", value: 9.5 },
        { date: "2020-04-01", value: 8.8 },
        { date: "2020-07-01", value: 9.8 },
        { date: "2020-10-01", value: 10.2 },
        { date: "2021-01-01", value: 10.5 },
        { date: "2021-04-01", value: 11 },
        { date: "2021-07-01", value: 11.5 },
        { date: "2021-10-01", value: 12 },
        { date: "2022-01-01", value: 12.5 },
        { date: "2022-04-01", value: 13 },
        { date: "2022-07-01", value: 13.5 },
        { date: "2022-10-01", value: 14 },
        { date: "2023-01-01", value: 14.5 },
        { date: "2023-04-01", value: 15 },
        { date: "2023-07-01", value: 15.5 },
  ...
  c0 = M.createContext(),
  d0 = ({ children: r }) => {
    const [y, x] = M.useState(null),
      d = (U) => gt.holdings.filter((T) => T.pan === U),
      v = (U) =>
        U.reduce(
          (T, G) => T + (G.asset_class === "MUTUAL_FUND" ? G.current_value : 0),
          0,
        ),
      N = M.useMemo(() => {
        if (!y) return [];
        if (y.role === "AGENT") {
          const T = gt.agent_client_map
            .filter((G) => G.agent_id === y.id)
            .map((G) => G.client_id);
          return gt.users
            .filter((G) => T.includes(G.id))
            .map((G) => {
              const le = d(G.pan);
              return { ...G, isActive: !0, value: v(le), portfolio: le };
            });
        }
        return [];
      }, [y]),
      O = M.useMemo(() => {
        ...
        if (y.role === "AGENT")
          N.forEach((G) => {
            U += G.value;
            const le = G.portfolio.filter((ee) => ee.is_sip_active).length;
            T += le;
          });
        else {
          const G = d(y.pan);
          ((U = v(G)), (T = G.filter((le) => le.is_sip_active).length));
        }
        return {
          totalAUM: U,
          activeSips: T,
          totalClients: y.role === "AGENT" ? N.length : 0,
          monthlyCommission: y.role === "AGENT" ? "1,25,000" : "0",
          premiumDue: "25,000",
          activePolicies: 12,
          retentionRate: "94%",
        };
      ...
      D = M.useMemo(() => {
        if (!y) return [];
        if (y.role === "AGENT") {
          const U = N.map((T) => T.pan);
          return gt.holdings.filter(
            (T) => T.asset_class === "INSURANCE" && U.includes(T.pan),
          );
        }
        return gt.holdings.filter(
          (U) => U.asset_class === "INSURANCE" && U.pan === y.pan,
        );
      }, [y, N]),
      C = M.useMemo(() => {
        if (!y) return [];
        if (y.role === "AGENT") {
          const U = N.map((T) => T.pan);
          return gt.holdings.filter((T) => U.includes(T.pan));
        }
        return gt.holdings.filter((U) => U.pan === y.pan);
      }, [y, N]),
      b = M.useMemo(() => gt.performance_data || {}, []);
    return n.jsx(c0.Provider, {
      value: {
        currentUser: y,
        setCurrentUser: x,
        allUsers: gt.users,
  ...
  yt = () => M.useContext(c0);
const sh = (r) => r.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(),
  ih = (r) =>
    r.replace(/^([A-Z])|[\s-_]+(\w)/g, (y, x, d) =>
      d ? d.toUpperCase() : x.toLowerCase(),
    ),
  Pf = (r) => {
    const y = ih(r);
  ...
  o0 = (...r) =>
    r
      .filter((y, x, d) => !!y && y.trim() !== "" && d.indexOf(y) === x)
      .join(" ")
      .trim(),
  uh = (r) => {
    for (const y in r)
  ...
  (
    ...
    M.createElement(
      "svg",
      {
        ...
        height: y,
        stroke: r,
        strokeWidth: d ? (Number(x) * 24) / Number(y) : x,
        className: o0("lucide", v),
        ...(!N && !uh(D) && { "aria-hidden": "true" }),
        ...D,
      },
      [
        ...O.map(([b, U]) => M.createElement(b, U)),
        ...(Array.isArray(N) ? N : [N]),
      ],
    ),
);
const $ = (r, y) => {
  const x = M.forwardRef(({ className: d, ...v }, N) =>
    M.createElement(dh, {
      ref: N,
      iconNode: y,
      className: o0(`lucide-${sh(Pf(r))}`, `lucide-${r}`, d),
      ...v,
    }),
  );
...
const gh = [["path", { d: "M20 6 9 17l-5-5", key: "1gmf2c" }]],
  f0 = $("check", gh);
const yh = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]],
  Hn = $("chevron-down", yh);
const jh = [["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }]],
  Rn = $("chevron-right", jh);
...
const A1 = [
  ...
  M1 = ({ icon: r, label: y, active: x, onClick: d }) =>
    n.jsxs("button", {
      onClick: d,
      className: `flex flex-col items-center gap-1 min-w-[64px] relative transition-colors ${x ? "text-indigo-600" : "text-slate-500 hover:text-slate-700"}`,
      children: [
        n.jsx(r, { size: 24, strokeWidth: x ? 2.5 : 2 }),
        n.jsx("span", {
          className: `text-xs font-semibold ${x ? "text-indigo-600" : "text-slate-500"}`,
          children: y,
        }),
      ],
    }),
  E1 = ({ activeTab: r, setActiveTab: y }) => {
    ...
    return n.jsx("nav", {
      className:
        "fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-sm border-t border-slate-200 px-2 py-2 flex justify-around items-start z-40",
      children: v.map((N) =>
        n.jsx(
          M1,
          {
  ...
  w1 = ({ id, icon: r, title: y, details: x, implemented: d, onNavigate: v }) => {
    const [N, O] = M.useState(!1),
      ...
      C =
        "absolute w-full h-full backface-hidden rounded-xl shadow-md p-4 flex flex-col justify-between transition-transform duration-700";
    return n.jsx("div", {
      className: "perspective-1000 h-40",
      onClick: D,
      children: n.jsxs("div", {
        className: `relative w-full h-full transition-transform duration-700 transform-style-3d ${N ? "rotate-y-180" : ""}`,
        children: [
          n.jsxs("div", {
  ...
  T1 = [
    {
      id: "insurance",
      title: "Insurance",
      icon: n.jsx(qc, { className: "text-blue-500" }),
      implemented: !0,
      details: "Comprehensive life and general insurance policies.",
    },
    {
      id: "mutual-funds",
      title: "Mutual Funds",
      icon: n.jsx(p0, { className: "text-green-500" }),
      implemented: !0,
      details: "Diverse portfolio of mutual funds to grow your wealth.",
    },
    {
      id: "fd-rd",
      title: "FD/RD",
      icon: n.jsx(r0, { className: "text-red-500" }),
      implemented: !1,
      details: "Secure your savings with fixed and recurring deposits.",
    },
    {
      id: "nps",
      title: "NPS",
    ...
    },
    {
      id: "digital-gold",
      title: "Digital Gold",
      icon: n.jsx(ni, { className: "text-yellow-500" }),
      implemented: !1,
      details: "Invest in 24K gold digitally, anytime, anywhere.",
    },
    {
      id: "loan-mf",
      title: "Loan Against MF",
      icon: n.jsx(v0, { className: "text-teal-500" }),
      implemented: !0,
      details: "Get instant loans against your mutual fund investments.",
    },
    {
      id: "loan-home",
      title: "Home Loan",
      icon: n.jsx(Rc, { className: "text-orange-500" }),
      implemented: !1,
  ...
  D1 = ({ client: r, onInvest: y, onViewPortfolio: x }) =>
    n.jsxs("div", {
      className:
        "bg-white rounded-3xl border border-slate-100 p-5 shadow-sm hover:shadow-md transition-all relative mb-4 group",
      children: [
        n.jsxs("div", {
          ...
          children: [
              ...
              children: [
                n.jsxs("div", {
                  ...
                  children: [
                    n.jsx("h3", {
                      className:
                        "text-lg font-bold text-slate-800 leading-none",
                      children: r.name,
                    }),
                    r.isActive
                      ? n.jsxs("span", {
                ...
                n.jsx("p", {
                  className:
                    "text-slate-400 text-[11px] font-semibold mt-2 uppercase tracking-tight",
                  children: "Total Investment Value",
                }),
                n.jsxs("p", {
                  className:
                    "text-2xl font-black text-mj-blue mt-0.5 tracking-tight",
                  children: ["₹ ", r.value],
                }),
              ],
            }),
            n.jsx("button", {
              onClick: x,
              className:
                "text-mj-blue p-1 hover:translate-x-1 transition-transform",
              children: n.jsx(Rn, { className: "w-6 h-6" }),
            }),
          ],
        }),
        n.jsxs("div", {
          ...
          children: [
            n.jsx("button", {
              onClick: x,
              className:
                "flex-1 py-3 rounded-2xl border-2 border-mj-blue text-mj-blue font-bold text-sm hover:bg-blue-50 transition-colors",
              children: "View Portfolio",
            }),
            n.jsx("button", {
              onClick: y,
              className:
                "flex-1 py-3 rounded-2xl bg-mj-blue text-white font-bold text-sm hover:bg-[#002244] transition-all shadow-lg shadow-blue-900/10",
              children: "Invest More",
            }),
          ],
        }),
      ],
    }),
  O1 = ({ onViewPortfolio: r }) => {
    const { clients: y } = yt(),
      [x, d] = M.useState(""),
      v = y.filter(
        (N) =>
          N.name.toLowerCase().includes(x.toLowerCase()) ||
          N.email.toLowerCase().includes(x.toLowerCase()),
      );
    return n.jsxs("div", {
      className: "animate-in fade-in duration-500 pb-20",
      children: [
        n.jsxs("header", {
          className: "px-5 pt-6 sticky top-0 bg-slate-50 z-10 pb-4",
          children: [
            n.jsx("div", {
              className: "flex justify-between items-center",
              children: n.jsx("button", {
                className: "p-2 bg-white rounded-full shadow-sm text-mj-blue",
                children: n.jsx(li, { size: 20 }),
              }),
            }),
            n.jsx("h1", {
              className: "text-2xl font-bold mt-4 text-slate-900",
              children: "My Clients",
            }),
            n.jsxs("div", {
              ...
              children: [
                ...
                n.jsx("input", {
                  ...
                  className:
                    "w-full bg-white pl-10 pr-4 py-3 rounded-xl border-none shadow-sm text-sm focus:ring-2 focus:ring-mj-blue outline-none",
                }),
              ],
            }),
          ],
  ...
  U1 = ({ policy: r, isOpen: y, onClose: x }) => {
    const { currentUser: d } = yt(),
      [v, N] = M.useState(3),
      [O, D] = M.useState(["mobile"]),
      [C, b] = M.useState(0),
      [U, T] = M.useState("self"),
      [G, le] = M.useState(!1);
    if (
      (M.useEffect(() => {
        if ((y && le(!1), r && r.next_due_date)) {
          const Y = new Date(),
            H = new Date(r.next_due_date) - Y,
            q = Math.ceil(H / (1e3 * 60 * 60 * 24));
          b(q);
        }
      }, [r, y]),
        !y || !r)
    ...
    return n.jsx("div", {
      ...
      children: n.jsxs("div", {
        className:
          "bg-white w-full max-w-md rounded-t-[40px] p-6 pb-12 flex flex-col animate-in slide-in-from-bottom duration-300",
        children: [
          n.jsxs("div", {
  ...
  H1 = [
    { id: "upi", name: "UPI", icon: Ua, desc: "Google Pay, PhonePe, Paytm" },
    {
      id: "netbanking",
      name: "Net Banking",
      icon: b0,
  ...
  S0 = ({ policy: r, isOpen: y, onClose: x }) => {
    const [d, v] = M.useState(1),
      [N, O] = M.useState("upi");
    if (!y || !r) return null;
    const D = () => {
      v(2);
        ...
        children: [
          n.jsxs("div", {
            ...
            children: [
              n.jsx("h2", {
                className: "text-xl font-bold text-mj-blue",
                children: d === 1 ? "Pay Premium" : "Payment Method",
              }),
              n.jsx("button", {
                onClick: x,
                className: "p-2 bg-slate-100 rounded-full text-slate-500",
  ...
  R1 = ({ policy: r, clientDetails: y, isOpen: x, onClose: d }) => {
    const [v, N] = M.useState("mobile"),
      [O, D] = M.useState(""),
      [C, b] = M.useState(!1);
    if (
      (M.useEffect(() => {
        ...
        (O(3),
          setTimeout(() => {
            (y(),
              O(1),
              C(""),
              U({ type: "Life Insurance", policyNumber: "", provider: "" }),
              G(""));
          }, 2e3));
      },
      Y = k1.filter((H) => H.toLowerCase().includes(T.toLowerCase())),
      W = (H) => {
        (U({ ...b, provider: H }), G(H), ee(!1));
      };
    return n.jsx("div", {
      className:
        "fixed inset-0 z-[100] flex items-end justify-center bg-black/40 backdrop-blur-sm animate-in fade-in duration-200",
      children: n.jsxs("div", {
        className:
          "bg-white w-full max-w-md rounded-t-[40px] p-6 pb-12 flex flex-col animate-in slide-in-from-bottom duration-300 h-[80vh]",
        children: [
          n.jsxs("div", {
            className: "flex justify-between items-center mb-6",
            children: [
  ...
  q1 = () => {
    const { policies: r, clients: y, currentUser: x } = yt(),
      [d, v] = M.useState(""),
      [N, O] = M.useState(null),
      [D, C] = M.useState(null),
      [b, U] = M.useState(null),
      ...
      I = (Z) => {
        ...
        const R = new Date(),
          ce = new Date(Z);
        (R.setHours(0, 0, 0, 0), ce.setHours(0, 0, 0, 0));
        const ge = ce - R,
          Ee = Math.ceil(ge / (1e3 * 60 * 60 * 24));
        if (Ee < 0) {
          ...
          r
            .map((Z) => {
              let R = "Unknown",
                ce = "unknown",
                ge = {};
              if (x.role === "CUSTOMER") ((R = x.name), (ce = x.id), (ge = x));
              else {
                const Ee = y.find((Te) => Te.pan === Z.pan);
                Ee && ((R = Ee.name), (ce = Ee.id), (ge = Ee));
              }
              return {
                ...Z,
                clientName: R,
                clientId: ce,
                clientDetails: ge,
                amount: (Z.premium_amount || 0).toLocaleString("en-IN"),
                sumAssured: (Z.sum_assured || 0).toLocaleString("en-IN"),
                statusDetails: I(Z.next_due_date),
              };
            })
            .filter((Z) =>
              Z.clientName.toLowerCase().includes(d.toLowerCase()),
            ),
        [r, y, x, d],
      ),
      W = M.useMemo(() => {
        ...
        return (
          Y.forEach((R) => {
            (Z[R.clientId] ||
              ...
              Z[R.clientId].policies.push(R),
              (Z[R.clientId].totalPremium += R.premium_amount));
          }),
          Object.values(Z)
        );
      }, [Y]),
      H = M.useMemo(() => {
        const Z = Y.reduce((R, ce) => R + (ce.premium_amount || 0), 0);
        return {
          count: Y.length,
          totalPremium: Z.toLocaleString("en-IN"),
          activeCount: Y.filter((R) => R.status === "Active").length,
        };
      }, [Y]),
      q = (Z) => {
        O(N === Z ? null : Z);
      ...
      Q = x && x.role === "AGENT";
    return n.jsxs("div", {
      className: "animate-in slide-in-from-right duration-500 pb-24",
      children: [
        n.jsx("header", {
          className: "px-5 pt-6",
          children: n.jsx("h1", {
            className: "text-3xl font-extrabold text-[#003366] mt-4",
            children: "Insurance",
          }),
        }),
        n.jsxs("div", {
          className: "px-5 mt-6 flex gap-3 overflow-x-auto no-scrollbar pb-2",
          children: [
            n.jsx(wc, {
              title: "Total Policies",
              value: H.count,
              sub: "Linked to ARN",
              icon: n.jsx(ni, { size: 16 }),
              color: "text-mj-green",
            }),
            n.jsx(wc, {
              title: "Total Premium",
              value: `₹ ${H.totalPremium}`,
              sub: "Annual Collectable",
              icon: n.jsx(Ec, { size: 16 }),
              color: "text-slate-400",
            }),
            n.jsx(wc, {
              title: "Active",
              value: H.activeCount,
              sub: "Policies In-Force",
              icon: n.jsx(Tc, { size: 16 }),
              color: "text-mj-green",
            }),
          ],
        }),
        n.jsx("div", {
          ...
          children: n.jsxs("div", {
            ...
            children: [
              n.jsx(Bc, {
                className:
                  "absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 w-4 h-4",
              }),
              n.jsx("input", {
                type: "text",
                ...
                className:
                  "w-full bg-white border border-slate-200 rounded-xl py-2.5 pl-11 pr-4 text-sm outline-none focus:ring-2 focus:ring-mj-blue transition-all",
              }),
            ],
          }),
        }),
            ...
            n.jsxs("div", {
              ...
              children: [
                ...
                n.jsx("button", {
                  onClick: () => ee(!0),
                  className:
                    "p-1.5 bg-mj-blue text-white rounded-lg shadow-sm hover:bg-opacity-90 transition-all",
                  children: n.jsx(li, { size: 18 }),
                }),
              ],
            }),
            n.jsx("div", {
        ...
        n.jsx(U1, { policy: D, isOpen: !!D, onClose: () => C(null) }),
        n.jsx(S0, { policy: b, isOpen: !!b, onClose: () => U(null) }),
        n.jsx(R1, {
          policy: T,
          clientDetails: T?.clientDetails,
          isOpen: !!T,
          onClose: () => G(null),
        }),
        n.jsx(B1, { isOpen: le, onClose: () => ee(!1) }),
      ],
    });
  },
  wc = ({ title: r, value: y, sub: x, icon: d, color: v }) =>
    n.jsxs("div", {
      className:
        "min-w-[150px] bg-white p-4 rounded-2xl border border-slate-100 shadow-sm",
      children: [
        n.jsxs("div", {
          ...
          children: [
            n.jsx("p", {
              className:
                "text-[10px] text-slate-500 font-bold uppercase tracking-tight",
              children: r,
            }),
            n.jsx("div", { className: "text-mj-blue opacity-40", children: d }),
          ],
        }),
        n.jsx("h3", {
          className: "text-xl font-extrabold text-mj-blue",
          children: y,
        }),
        x &&
        n.jsx("p", {
  ...
  Y1 = () => {
    ...
    const d = [
      { label: "Days", value: y.days },
      { label: "Hours", value: y.hours },
      { label: "Mins", value: y.minutes },
      { label: "Secs", value: y.seconds },
    ];
    return n.jsx("div", {
      className: "bg-black/20 rounded-2xl p-3 border border-white/10 shadow-lg",
      children: n.jsx("div", {
              ...
              children: [
                n.jsxs("div", {
                  ...
                  children: [
                    n.jsx("div", {
                      className:
                        "bg-white/20 backdrop-blur-md rounded-lg w-11 h-11 flex items-center justify-center border border-white/20 shadow-sm",
                      children: n.jsx("span", {
                        className: "text-xl font-bold font-mono leading-none",
                        children: String(v.value).padStart(2, "0"),
                      }),
                    }),
                    n.jsx("span", {
                      className:
                        "text-[8px] font-bold uppercase mt-1.5 opacity-90 tracking-wider",
                      children: v.label,
                    }),
                  ],
                }),
  ...
  G1 = ({ isOpen: r, onClose: y, currentPlan: x = "growth" }) => {
    const [d, v] = M.useState(x),
      [N, O] = M.useState(!1),
      [D, C] = M.useState("monthly"),
      [b, U] = M.useState(""),
      [T, G] = M.useState(!1),
      [le, ee] = M.useState(""),
      [J, I] = M.useState(!1),
    ...
    return n.jsxs("div", {
      className:
        "fixed inset-0 z-[100] bg-white animate-in slide-in-from-right duration-300 flex flex-col",
      children: [
        n.jsxs("div", {
          className:
            "px-5 pt-6 pb-4 flex items-center gap-4 border-b border-slate-100 shrink-0",
          children: [
            n.jsx("button", {
              onClick: y,
              className:
            ...
            n.jsxs("h2", {
              className:
                "text-xl font-bold text-mj-blue flex items-center gap-2",
              children: [
                n.jsx(h0, { size: 24, className: "text-amber-500" }),
                "Subscription Plans",
              ],
            }),
          ],
  ...
  _0 = ({ isOpen: r, onClose: y }) => {
    const [x, d] = M.useState(1),
    ...
    return n.jsx("div", {
      ...
      children: n.jsxs("div", {
        className:
          "bg-white w-full max-w-md rounded-t-[40px] p-6 pb-8 flex flex-col animate-in slide-in-from-bottom duration-300 h-[85vh]",
        children: [
          n.jsxs("div", {
            className: "flex justify-between items-center mb-6",
            children: [
  ...
  X1 = ({ isOpen: r, onClose: y, initialData: x, onSave: d }) => {
    const [v, N] = M.useState({ name: "", relation: "", dob: "" }),
      [O, D] = M.useState(!1);
    if (
      (M.useEffect(() => {
    ...
    return n.jsx("div", {
      ...
      children: n.jsxs("div", {
        className:
          "bg-white w-full max-w-md rounded-t-[40px] p-6 pb-12 flex flex-col animate-in slide-in-from-bottom duration-300 h-[60vh]",
        children: [
          n.jsxs("div", {
            className: "flex justify-between items-center mb-6",
            children: [
              n.jsx("h2", {
                className: "text-xl font-bold text-mj-blue",
                children: x ? "Edit Member" : "Add Family Member",
              }),
              n.jsx("button", {
                onClick: y,
                className: "p-2 bg-slate-100 rounded-full text-slate-500",
  ...
  Q1 = ({ isOpen: r, onClose: y, initialData: x, onSave: d }) => {
    const [v, N] = M.useState({ bank_name: "", account_number: "", limit: "" }),
      [O, D] = M.useState(!1);
    if (
      (M.useEffect(() => {
        ...
        children: [
          n.jsxs("div", {
            ...
            children: [
              n.jsx("h2", {
                className: "text-xl font-bold text-mj-blue",
                children: x ? "Edit Mandate" : "Add New Mandate",
              }),
              n.jsx("button", {
                onClick: y,
                className: "p-2 bg-slate-100 rounded-full text-slate-500",
  ...
  V1 = () => {
    const { currentUser: r, setCurrentUser: y, clients: x } = yt(),
      [d, v] = M.useState(null),
      [N, O] = M.useState(r.arn_code || ""),
      [D, C] = M.useState(!1),
      [b, U] = M.useState(!1),
      [T, G] = M.useState(""),
      [le, ee] = M.useState("Portfolio Valuation"),
      [J, I] = M.useState(r.email),
      [Y, W] = M.useState(!1),
      [H, q] = M.useState({
        email: !0,
        sms: !0,
      ...
      [Q, Z] = M.useState(!1),
      [R, ce] = M.useState(!1),
      [ge, Ee] = M.useState("basic"),
      [Te, Re] = M.useState(!1),
      [Bt, ct] = M.useState(!1),
      [Ie, z] = M.useState(null),
      [B, P] = M.useState(!1),
      [be, pe] = M.useState(null),
      f = r.role?.toUpperCase() === "AGENT",
      E = (k) => {
        v(d === k ? null : k);
      },
      L = () => {
        (C(!1), U(!0), setTimeout(() => U(!1), 2e3));
      },
      V = () => {
        (W(!0), setTimeout(() => W(!1), 2500));
      },
      ae = (k) => {
        const Ye = Ie
          ? r.family_members.map((ze) => (ze.id === k.id ? k : ze))
          : [...(r.family_members || []), k];
        y({ ...r, family_members: Ye });
      },
      ue = (k) => {
        const Ye = be
          ? r.bank_mandates.map((ze) => (ze.id === k.id ? k : ze))
          : [...(r.bank_mandates || []), k];
        y({ ...r, bank_mandates: Ye });
      };
    return n.jsxs("div", {
      className: "px-5 pt-6 animate-in fade-in duration-500 pb-24",
      children: [
        n.jsx("h1", {
          className: "text-2xl font-bold text-mj-blue text-center",
          children: "My Profile",
        }),
        n.jsxs("div", {
          className:
            "mt-8 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-5 relative overflow-hidden",
          children: [
            n.jsx("div", {
              className: `absolute top-0 right-0 w-24 h-24 -mt-8 -mr-8 rounded-full opacity-10 ${f ? "bg-indigo-500" : "bg-emerald-500"}`,
            }),
            n.jsxs("div", {
              ...
              children: [
                n.jsx("img", {
                  ...
                  alt: "Profile",
                  className:
                    "w-16 h-16 rounded-full border-4 border-white shadow-sm object-cover bg-slate-100",
                }),
                n.jsx("div", {
                  className: `absolute -bottom-1 -right-1 w-7 h-7 rounded-full flex items-center justify-center border-2 border-white shadow-sm ${f ? "bg-indigo-600" : "bg-emerald-500"}`,
                  children: f
                    ? n.jsx(qc, { size: 14, className: "text-white" })
                    : n.jsx(Oa, { size: 14, className: "text-white" }),
                }),
              ],
            }),
            n.jsxs("div", {
              ...
              children: [
                n.jsxs("div", {
                  ...
                  children: [
                    n.jsx("h2", {
                      className:
                        "text-lg font-bold text-slate-800 truncate w-full",
                      children: r.name,
                    }),
                    n.jsxs("span", {
                      className: `inline-flex items-center gap-1 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider mt-1 ${f ? "bg-indigo-50 text-indigo-700 border border-indigo-100" : "bg-emerald-50 text-emerald-700 border border-emerald-100"}`,
                      children: [
                        f ? n.jsx(Fh, { size: 10 }) : n.jsx(Oa, { size: 10 }),
                        r.role,
                      ],
                    }),
                  ],
                ...
                n.jsxs("div", {
                  ...
                  children: [
                    n.jsxs("p", {
                      className:
                        "text-xs text-slate-500 font-medium flex items-center gap-2",
                      children: [
                        n.jsx("span", {
        ...
        n.jsxs("button", {
          className:
            "w-full mt-10 bg-mj-blue text-white py-4 rounded-full font-bold shadow-lg shadow-blue-900/10 flex items-center justify-center gap-2 active:scale-[0.98] transition-transform",
          children: [n.jsx(y0, { size: 20 }), "Logout"],
        }),
        n.jsxs("p", {
          className: "text-center text-[10px] text-slate-300 mt-6 font-mono",
          children: ["Logged in as: ", r.id, " • ", r.role],
        }),
        n.jsx(G1, { isOpen: R, onClose: () => ce(!1), currentPlan: ge }),
        n.jsx(_0, { isOpen: Te, onClose: () => Re(!1) }),
        n.jsx(X1, {
          isOpen: Bt,
          onClose: () => ct(!1),
          initialData: Ie,
  ...
  Kl = ({
    ...
    value: x,
    subText: d,
    valueColor: v = "text-slate-500",
    iconColor: N = "text-slate-400",
    bgColor: O = "bg-slate-50",
    onClick: D,
    expanded: C,
  }) =>
    n.jsxs("div", {
      onClick: D,
      className:
        "p-4 flex justify-between items-center hover:bg-slate-50 transition-colors cursor-pointer group",
      children: [
        n.jsxs("div", {
          className: "flex items-center gap-3",
          children: [
            n.jsx("div", {
              className: `p-2 rounded-xl transition-colors ${O} ${N}`,
              children: n.jsx(y, { size: 18, strokeWidth: 2.5 }),
            }),
            n.jsxs("div", {
              children: [
                n.jsx("span", {
  ...
  a0 = [
    ...
    { id: 5, name: "Axis Bluechip Fund", category: "Equity", risk: "High" },
    {
      id: 6,
  ...
  K1 = ({ client: r, isOpen: y, onClose: x }) => {
    const { currentUser: d } = yt(),
      [v, N] = M.useState(1),
      [O, D] = M.useState(""),
      [C, b] = M.useState(a0[0]),
  ...
  n0 = [
    ...
    { id: "m2", bank: "ICICI Bank", account: "**** 5678", limit: "₹ 50,000" },
  ],
  J1 = [
    "HDFC Bank",
    "ICICI Bank",
  ...
  F1 = ({ holding: r, isOpen: y, onClose: x }) => {
    const { currentUser: d } = yt(),
      [v, N] = M.useState(1),
      [O, D] = M.useState("5000"),
      [C, b] = M.useState("5"),
      [U, T] = M.useState("mandate"),
      [G, le] = M.useState(n0[0].id),
      [ee, J] = M.useState(""),
      [I, Y] = M.useState(!1);
    if (!y || !r) return null;
    const W = d && d.role === "AGENT",
      H = () => {
        (N(2),
          setTimeout(() => {
            (x(), N(1), T("mandate"), J(""));
    ...
    return n.jsx("div", {
      ...
      children: n.jsxs("div", {
        className:
          "bg-white w-full max-w-md rounded-t-[40px] p-6 pb-12 flex flex-col animate-in slide-in-from-bottom duration-300 h-[85vh]",
        children: [
          n.jsxs("div", {
            className: "flex justify-between items-center mb-6",
            children: [
              n.jsx("h2", {
                className: "text-xl font-bold text-mj-blue",
                children: W ? "Setup SIP for Client" : "Start SIP",
              }),
              n.jsx("button", {
                onClick: x,
                className: "p-2 bg-slate-100 rounded-full text-slate-500",
  ...
  $1 = ({ holding: r, isOpen: y, onClose: x }) => {
    const [d, v] = M.useState(1),
      [N, O] = M.useState(""),
  ...
  s0 = ({ client: r, onBack: y }) => {
    const [x, d] = M.useState(null),
      [v, N] = M.useState("ALL"),
      [O, D] = M.useState("ALL"),
      [C, b] = M.useState(null),
      [U, T] = M.useState(null),
      [G, le] = M.useState(null),
      ee = M.useMemo(
        () =>
          r.portfolio
            ? r.portfolio.filter(
      ...
      J = M.useMemo(() => {
        ...
        return (
          ee.forEach((q) => {
            (H[q.amc] ||
              (H[q.amc] = { name: q.amc, totalValue: 0, holdings: [] }),
              H[q.amc].holdings.push(q),
              (H[q.amc].totalValue += q.current_value));
          }),
          Object.values(H)
        );
      }, [ee]),
    ...
    return n.jsxs("div", {
      className:
        "animate-in slide-in-from-right duration-300 bg-white min-h-screen pb-24",
      children: [
        n.jsxs("header", {
          className:
        ...
        n.jsxs("main", {
          ...
          children: [
            n.jsxs("div", {
              className: "bg-mj-blue text-white p-6 rounded-3xl shadow-lg mb-8",
              children: [
                n.jsxs("div", {
                  className: "flex justify-between items-start",
                  children: [
                    n.jsxs("div", {
                      children: [
                        ...
                        n.jsxs("h2", {
                          ...
                          children: ["₹ ", (r.value / 1e5).toFixed(2), " L"],
                        }),
                      ],
                    }),
                    n.jsxs("div", {
                ...
                n.jsxs("div", {
                  className:
                    "flex items-center gap-2 mt-4 bg-white/10 w-fit px-3 py-1 rounded-full",
                  children: [
                    n.jsx(ni, { size: 14, className: "text-mj-green" }),
                    n.jsx("span", {
                      className: "text-xs font-bold",
                      children: "+12.4% (Overall Gain)",
                    }),
                  ],
                }),
              ],
            ...
            n.jsxs("div", {
              className:
                "flex gap-3 mb-2 overflow-x-auto pb-2 scrollbar-hide items-center",
              children: [
                n.jsxs("div", {
                  className:
                    "flex items-center gap-2 text-slate-400 text-xs font-medium pr-2 border-r border-slate-200",
                  children: [
                    n.jsx(Bh, { size: 14 }),
                    n.jsx("span", { children: "Filters" }),
                  ],
                }),
                n.jsxs("select", {
                  value: v,
                  onChange: (H) => N(H.target.value),
                  className: `bg-slate-50 border border-slate-200 text-slate-700 text-xs font-medium rounded-full px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-mj-blue/20 ${v !== "ALL" ? "bg-blue-50 border-blue-200 text-mj-blue" : ""}`,
                  children: [
                    n.jsx("option", { value: "ALL", children: "All Types" }),
                    n.jsx("option", { value: "Equity", children: "Equity" }),
                    n.jsx("option", { value: "Debt", children: "Debt" }),
                    n.jsx("option", { value: "Hybrid", children: "Hybrid" }),
                  ],
                }),
                n.jsxs("select", {
                  value: O,
                  onChange: (H) => D(H.target.value),
                  className: `bg-slate-50 border border-slate-200 text-slate-700 text-xs font-medium rounded-full px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-mj-blue/20 ${O !== "ALL" ? "bg-blue-50 border-blue-200 text-mj-blue" : ""}`,
                  children: [
                    n.jsx("option", { value: "ALL", children: "All Caps" }),
                    n.jsx("option", {
                      value: "Large Cap",
                      children: "Large Cap",
                    }),
                    n.jsx("option", { value: "Mid Cap", children: "Mid Cap" }),
                    n.jsx("option", {
                      value: "Small Cap",
                      children: "Small Cap",
                    }),
                    ...
                    n.jsx("option", { value: "Liquid", children: "Liquid" }),
                  ],
                }),
                W &&
                n.jsxs("button", {
        ...
        n.jsx(K1, { client: r, isOpen: !!C, onClose: () => b(null) }),
        n.jsx(F1, { holding: U, isOpen: !!U, onClose: () => T(null) }),
        n.jsx($1, { holding: G, isOpen: !!G, onClose: () => le(null) }),
      ],
    });
  },
  W1 = () => {
    const { holdings: r, clients: y, currentUser: x } = yt(),
      [d, v] = M.useState("All"),
      [N, O] = M.useState(null),
      [D, C] = M.useState(!1),
      b = 90,
      U = M.useMemo(
        () =>
          r
            ...
            .map((I) => {
              let Y = "Unknown";
              if (x.role === "CUSTOMER") Y = x.name;
              else {
                const Q = y.find((Z) => Z.pan === I.pan);
                Y = Q ? Q.name : "Unknown Client";
              }
              let W = "Upcoming",
                H = "Premium Due",
                q = "Date N/A";
              if (I.next_due_date) {
                const Q = new Date(),
                  Z = new Date(I.next_due_date);
                (Q.setHours(0, 0, 0, 0), Z.setHours(0, 0, 0, 0));
                const R = Z - Q,
                  ce = Math.ceil(R / (1e3 * 60 * 60 * 24));
                (ce < 0
                  ? Math.abs(ce) <= b
                    ? (W = "In Grace Period")
                    : (W = "Overdue")
                  : ce <= 30 && (W = "Due Soon"),
                  (q = Z.toLocaleDateString("en-IN", {
                    day: "numeric",
                    month: "short",
                  })));
              }
              return (
                ...
                ((H = "KYC Pending"), (W = "Urgent"), (q = "Immediate")),
                {
                  ...
                  amount: I.premium_amount
                    ? `₹ ${I.premium_amount.toLocaleString("en-IN")}`
                    : I.invested
      ...
      T = M.useMemo(
        () => (d === "All" ? U : U.filter((J) => J.type === d)),
        [U, d],
      ),
      G = x && x.role === "AGENT",
      le = x && x.role === "CUSTOMER",
      ee = (J) => {
        switch (J) {
          case "Overdue":
          case "Urgent":
          ...
          default:
            return {
              ...
              badge: "bg-emerald-50 text-mj-green border-emerald-100",
            };
        }
      };
    return n.jsxs("div", {
      ...
      children: [
        ...
        n.jsx("div", {
          ...
          children: n.jsx("div", {
            ...
            children: ["All", "Premium Due", "SIP Missed", "KYC Pending"].map(
              (J) =>
                n.jsx(
                  "button",
                  {
                    onClick: () => v(J),
                    className: `whitespace-nowrap px-4 py-1.5 border rounded-full text-xs font-bold transition-colors ${d === J ? "bg-mj-blue text-white border-mj-blue" : "bg-white border-slate-200 text-slate-600"}`,
                    children: J,
                  },
                  J,
                ),
  ...
  I1 = ({ note: r }) => {
    let y = Dc,
      x = "text-blue-500 bg-blue-50";
    switch (r.type) {
      case "alert":
        ((y = m0), (x = "text-red-500 bg-red-50"));
        break;
      case "warning":
        ((y = N0), (x = "text-amber-500 bg-amber-50"));
        break;
      case "success":
        ((y = it), (x = "text-green-500 bg-green-50"));
        break;
      default:
        ((y = Dc), (x = "text-blue-500 bg-blue-50"));
    }
    return n.jsxs("div", {
      className:
        "bg-white p-4 rounded-xl border border-slate-100 shadow-sm flex gap-4",
      children: [
        n.jsx("div", {
          className: `p-3 rounded-full h-fit ${x}`,
          children: n.jsx(y, { size: 20 }),
        }),
        n.jsxs("div", {
          className: "flex-1",
          children: [
            n.jsxs("div", {
              ...
              children: [
                ...
                n.jsx("span", {
                  className: "text-xs text-slate-400 whitespace-nowrap ml-2",
                  children: r.date,
                }),
              ],
            }),
  ...
  P1 = ({ onBack: r }) => {
    const { notifications: y } = yt();
    return n.jsxs("div", {
      className:
        "animate-in slide-in-from-right duration-300 bg-slate-50 min-h-screen pb-20",
      children: [
        n.jsxs("div", {
          className:
            "bg-white px-5 py-4 sticky top-0 z-10 border-b border-slate-100 flex items-center gap-3 shadow-sm",
          children: [
            n.jsx("button", {
              onClick: r,
              className:
                "p-2 -ml-2 rounded-full hover:bg-slate-50 text-slate-600",
              children: n.jsx(Uc, { size: 24 }),
            }),
            n.jsx("h1", {
              className: "text-xl font-bold text-mj-blue flex-1",
      ...
      children: [
        n.jsxs("div", {
          ...
          children: [
            ...
            n.jsx("h2", { style: { color: "#1a1a1a" }, className: "text-2xl font-black", children: "Insurance Plans" })
          ]
        }),
        n.jsxs("div", {
              ...
              children: [
                ...
                n.jsxs("div", {
                  ...
                  children: [
                    ...
                    n.jsx("h3", { style: { color: "#1a1a1a" }, className: "text-2xl font-black mb-2", children: "Health Insurance" }),
                    n.jsx("p", { style: { color: "#4b5563" }, className: "text-sm font-medium leading-relaxed max-w-[80%]", children: "Protect yourself and your family with premium health protection." }),
      ...
      children: [
        n.jsxs("div", {
          ...
          children: [
            ...
            n.jsx("h2", { style: { color: "#1a1a1a" }, className: "text-2xl font-black", children: y === "health" ? "Health Plans" : "Life Plans" })
          ]
        }),
        n.jsx("div", {
          className: "space-y-4",
            ...
            children: [
              n.jsxs("div", {
                ...
                children: [
                  n.jsxs("div", {
                    children: [
                      n.jsx("h4", { style: { color: "#1a1a1a" }, className: "font-black text-lg", children: W.name }),
                      n.jsxs("div", {
  ...
  ab = ({ pageTitle: r, onMenuClick: y }) => {
    const { currentUser: x } = yt();
    return n.jsx("div", {
      className:
        "bg-white/90 backdrop-blur sticky top-0 z-30 pt-4 pb-3 px-4 shadow-sm",
      children: n.jsxs("div", {
        className: "flex justify-between items-start",
        children: [
          n.jsxs("div", {
            ...
            children: [
              ...
              n.jsxs("div", {
                className:
                  "flex items-center text-xs text-slate-500 mt-2 font-medium",
                children: [
                  n.jsx("span", {
                    className: "opacity-70",
                    children: x?.name || "User",
                  }),
                  n.jsx(Rn, { size: 12, className: "mx-1 opacity-50" }),
                  n.jsx("span", {
          ...
          n.jsx("button", {
            onClick: y,
            className:
              "p-2 mt-1 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-700 transition-colors",
            children: n.jsx(Ph, { size: 22 }),
          }),
        ],
      }),
    });
  },
  nb = ({ onLogin: r, onNavigateSignup: y }) => {
      ...
      C = (b) => {
        ...
        U
          ...
          : x === "demo@agent.com"
            ...
            : x === "demo@customer.com"
              ? r(gt.users[1])
              : D("Invalid credentials. Try demo@agent.com");
      };
    return n.jsxs("div", {
      className:
        "min-h-screen bg-slate-50 flex flex-col justify-center px-6 py-12 lg:px-8 animate-in fade-in duration-500",
      children: [
        n.jsxs("div", {
          ...
          children: [
            ...
            n.jsx("h2", {
              className:
                "mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-slate-900",
                  ...
                  children: [
                    ...
                    n.jsx("div", {
                      ...
                      children: n.jsx("input", {
                        ...
                        className:
                          "block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-mj-blue sm:text-sm sm:leading-6 px-3",
                      }),
                    }),
                  ],
                }),
                      ...
                      children: [
                        ...
                        n.jsx("div", {
                          ...
                          children: n.jsx("a", {
                            href: "#",
                            className:
                              "font-semibold text-mj-blue hover:text-indigo-500",
            ...
            n.jsxs("p", {
              ...
              children: [
                ...
                n.jsx("button", {
                  onClick: y,
                  className:
                    "font-semibold leading-6 text-mj-blue hover:text-indigo-500",
              ...
              children: [
                ...
                n.jsxs("div", {
                  ...
                  children: [
                    n.jsx("button", {
                      onClick: () => {
                        (d("demo@agent.com"), N("password"));
                      },
                      className:
                        "text-xs bg-slate-200 px-3 py-1 rounded hover:bg-slate-300",
                      children: "Agent",
                    }),
                    n.jsx("button", {
                      onClick: () => {
                        (d("demo@customer.com"), N("password"));
                      },
                      className:
                        "text-xs bg-slate-200 px-3 py-1 rounded hover:bg-slate-300",
                      children: "Customer",
  ...
  sb = ({ onNavigateLogin: r, onSignupSuccess: y }) => {
    ...
    return n.jsxs("div", {
      className:
        "min-h-screen bg-slate-50 flex flex-col justify-center px-6 py-12 lg:px-8 animate-in slide-in-from-right duration-500",
      children: [
        n.jsxs("div", {
          className: "sm:mx-auto sm:w-full sm:max-w-sm",
          children: [
                  ...
                  children: [
                    ...
                    n.jsx("div", {
                      ...
                      children: n.jsx("input", {
                        ...
                        required: !0,
                        value: x.name,
                        onChange: (N) => d({ ...x, name: N.target.value }),
                        className:
                          "block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-mj-blue sm:text-sm sm:leading-6 px-3",
                      }),
                    }),
                  ...
                  children: [
                    ...
                    n.jsx("div", {
                      ...
                      children: n.jsx("input", {
                        ...
                        required: !0,
                        value: x.email,
                        onChange: (N) => d({ ...x, email: N.target.value }),
                        className:
                          "block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-mj-blue sm:text-sm sm:leading-6 px-3",
                      }),
                    }),
                  ...
                  children: [
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        n.jsx("button", {
                          type: "button",
                          onClick: () => d({ ...x, role: "CUSTOMER" }),
                          className: `flex justify-center rounded-md px-3 py-2 text-sm font-semibold shadow-sm ring-1 ring-inset ${x.role === "CUSTOMER" ? "bg-mj-blue text-white ring-mj-blue" : "bg-white text-slate-900 ring-slate-300 hover:bg-slate-50"}`,
                          children: "Customer",
                        }),
                        n.jsx("button", {
                          type: "button",
                          onClick: () => d({ ...x, role: "AGENT" }),
                          className: `flex justify-center rounded-md px-3 py-2 text-sm font-semibold shadow-sm ring-1 ring-inset ${x.role === "AGENT" ? "bg-mj-blue text-white ring-mj-blue" : "bg-white text-slate-900 ring-slate-300 hover:bg-slate-50"}`,
                          children: "Agent",
                        }),
                      ],
                    }),
                  ...
                  children: [
                    ...
                    n.jsx("div", {
                      ...
                      children: n.jsx("input", {
                        ...
                        required: !0,
                        value: x.password,
                        onChange: (N) => d({ ...x, password: N.target.value }),
                        className:
                          "block w-full rounded-md border-0 py-1.5 text-slate-900 shadow-sm ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-mj-blue sm:text-sm sm:leading-6 px-3",
                      }),
                    }),
  ...
  ib = ({ initialData: r, onComplete: y }) => {
    const x = r.method === "google",
      d = r.method === "mobile",
      [v, N] = M.useState({
      ...
      O = (D) => {
        D.preventDefault();
        const C = `${v.firstName} ${v.lastName}`;
        y({
          name: C,
          email: v.email,
          phone: v.phone,
    ...
    return n.jsxs("div", {
      className:
        "min-h-screen bg-slate-50 flex flex-col justify-center px-6 py-12 lg:px-8",
      children: [
        n.jsxs("div", {
          ...
          children: [
            n.jsx("h2", {
              className:
                "text-center text-2xl font-bold leading-9 tracking-tight text-slate-900",
              children: "One last step...",
            }),
            n.jsx("p", {
              className: "text-center text-sm text-slate-500 mt-2",
              children: "We need your PAN details to build your portfolio.",
            }),
          ],
        }),
        n.jsx("div", {
          ...
          children: n.jsx("div", {
            className:
              "bg-white py-8 px-6 shadow-sm ring-1 ring-slate-900/5 sm:rounded-xl",
                    ...
                    n.jsxs("div", {
                      children: [
                        ...
                        n.jsx("input", {
                          ...
                          value: v.firstName,
                          onChange: (D) =>
                            N({ ...v, firstName: D.target.value }),
                          className:
                            "block w-full rounded-md border-0 py-2 text-slate-900 ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-mj-blue sm:text-sm",
                        }),
                      ],
                    }),
                    n.jsxs("div", {
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("input", {
                          ...
                          readOnly: x,
                          value: v.email,
                          onChange: (D) => N({ ...v, email: D.target.value }),
                          className: `block w-full rounded-md border-0 py-2 pl-9 text-slate-900 ring-1 ring-inset ring-slate-300 sm:text-sm ${x ? "bg-slate-100 text-slate-500 cursor-not-allowed" : ""}`,
                        }),
                      ],
                    }),
                  ],
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("input", {
                          ...
                          readOnly: d,
                          value: v.phone,
                          onChange: (D) => N({ ...v, phone: D.target.value }),
                          className: `block w-full rounded-md border-0 py-2 pl-9 text-slate-900 ring-1 ring-inset ring-slate-300 sm:text-sm ${d ? "bg-slate-100 text-slate-500 cursor-not-allowed" : ""}`,
                        }),
                      ],
                    }),
                  ],
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("input", {
                          ...
                          value: v.pan,
                          onChange: (D) =>
                            N({ ...v, pan: D.target.value.toUpperCase() }),
                          className:
                            "block w-full rounded-md border-0 py-2.5 pl-9 text-slate-900 ring-1 ring-inset ring-slate-300 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-mj-blue sm:text-sm uppercase font-mono tracking-wide",
                        }),
                      ],
                    }),
                    n.jsx("p", {
                      className: "text-[10px] text-slate-400 mt-1",
                      children:
                        "Your PAN is required for fetching your investment portfolio.",
                    }),
                  ],
                }),
                n.jsxs("button", {
                  type: "submit",
                  className:
                    "flex w-full justify-center rounded-md bg-mj-blue px-3 py-2.5 text-sm font-bold leading-6 text-white shadow-sm hover:bg-indigo-800 gap-2 items-center mt-4",
                  children: ["Complete Setup ", n.jsx(fh, { size: 16 })],
                }),
              ],
            }),
          }),
  ...
  ub = () => {
    ...
    const I = (W) => {
      ...
      Y = () => {
        ...
        switch (C) {
          ...
          case "Referral":
            if (r && r.role !== "AGENT") return n.jsx("div", { className: "min-h-screen bg-slate-50" });
            return n.jsxs("div", {
          ...
          case "Subscription":
            ...
            return n.jsxs("div", {
              ...
              children: [
                ...
                n.jsx("p", { className: "text-slate-500 text-sm text-center mb-8", children: "All plans include the same great features" }),
                n.jsx("div", {
                  ...
                  children: [
                    {
                      ...
                      borderColor: "#f59e0b",
                      circleGrad: "linear-gradient(135deg, #f59e0b, #d97706)",
                      badgeBg: "#f59e0b",
                      titleColor: "#92400e",
                      textColor: "#b45309",
                      priceColor: "#78350f",
                    ...
                    },
                    {
                      ...
                      borderColor: "#10b981",
                      circleGrad: "linear-gradient(135deg, #10b981, #059669)",
                      badgeBg: "#10b981",
                      titleColor: "#065f46",
                      textColor: "#047857",
                      priceColor: "#064e3b",
                    ...
                    },
                    {
                      ...
                      borderColor: "#7c3aed",
                      circleGrad: "linear-gradient(135deg, #7c3aed, #6d28d9)",
                      badgeBg: "#7c3aed",
                      titleColor: "#4c1d95",
                      textColor: "#6d28d9",
                      priceColor: "#3b0764",
                    ...
                    style: {
                      ...
                      boxShadow: P.popular ? `0 10px 30px ${P.borderColor}44` : `0 4px 16px ${P.borderColor}22`,
                      position: "relative",
                    ...
                    children: [
                      n.jsx("div", {
                        style: {
                          ...
                          boxShadow: `0 2px 6px ${P.borderColor}55`,
                        },
                        children: P.badge,
                      }),
                      n.jsx("div", {
                      ...
                      n.jsxs("div", {
                        ...
                        children: [
                          n.jsx("span", {
                            style: { fontSize: "20px", fontWeight: 900, color: P.priceColor, lineHeight: 1 },
                            children: "\u20B9" + P.price,
                          }),
                          n.jsx("span", {
                            style: { fontSize: "10px", fontWeight: 600, color: P.periodColor, marginLeft: "3px", opacity: 0.7 },
                            children: P.period,
                          }),
                        ],
                      }),
                      n.jsx("div", {
                        style: { borderTop: `1px solid ${P.borderColor}44`, marginBottom: "12px" },
                      }),
                      n.jsx("div", {
                        ...
                        children: [
                          ...
                          children: [
                            n.jsx("div", {
                              ...
                              children: n.jsx(f0, { size: 9, strokeWidth: 3.5, color: P.borderColor }),
                            }),
                            n.jsx("span", {
                              style: { fontSize: "10px", fontWeight: 500, color: P.featColor, lineHeight: "1.35" },
                              children: feat,
                            }),
                          ],
                        }, idx)),
                      ...
                      n.jsx("button", {
                        style: {
                          ...
                          border: "none",
                          cursor: "pointer",
                          boxShadow: `0 4px 12px ${P.borderColor}55`,
                          marginTop: "auto",
                        },
    ...
    return n.jsxs("div", {
      className: "bg-slate-50 min-h-screen pb-20 font-sans text-slate-900",
      children: [
        n.jsx(tb, { isOpen: ee, onClose: () => J(!1), onNavigate: I }),
        n.jsx(ab, { pageTitle: C, onMenuClick: () => J(!0) }),
        Y(),
        n.jsx(E1, { activeTab: C, setActiveTab: I }),
        !1,
      ],
    });
  },
  cb = () => n.jsx(d0, { children: n.jsx(ub, {}) });
nh.createRoot(document.getElementById("root")).render(
  n.jsx(u0.StrictMode, { children: n.jsx(d0, { children: n.jsx(cb, {}) }) }),
);
